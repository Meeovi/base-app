...
import { SfScrollableDirection, SfScrollableButtonsPlacement, SfScrollableOnDragStartData, SfScrollableOnScrollData, SfScrollableOnPrevData, SfScrollableOnDragEndData, ScrollableOptions } from '../../index.ts';
...
declare const __VLS_component: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    direction: {
        type: PropType<`${SfScrollableDirection}`>;
        default: SfScrollableDirection;
    };
    buttonsPlacement: {
        type: PropType<`${SfScrollableButtonsPlacement}`>;
    ...
    drag: {
        type: PropType<ScrollableOptions["drag"]>;
        default: undefined;
    };
    prevDisabled: {
        type: BooleanConstructor;
