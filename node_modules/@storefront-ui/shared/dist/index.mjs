...
var a = (t, e, r) => E(t, typeof e != "symbol" ? e + "" : e, r);
...
function O(t, e) {
  ...
  } else return r === "function" ? t.toString() === e.toString() : !1;
  return !0;
}
const w = {
  reduceMotion: H,
...
class Et {
  ...
  prev() {
    var n, o;
    let e = !1;
    if ((o = (n = this.options) == null ? void 0 : n.onPrev) == null || o.call(n, { preventDefault: () => e = !0 }), e) return;
  ...
  next() {
    var n, o;
    let e = !1;
    if ((o = (n = this.options) == null ? void 0 : n.onNext) == null || o.call(n, { preventDefault: () => e = !0 }), e) return;
    const { container: r, options: s } = this;
    s.direction === u.vertical ? this.scrollTo({ top: r.scrollTop + r.clientHeight }) : this.scrollTo({ left: r.scrollLeft + r.clientWidth });
  }
  scrollToIndex(e) {
...
const x = (t, e) => e.findIndex((r) => r === t), et = (t, e) => {
  ...
  if (m && (r == null || r.preventDefault()), t) {
    if (it(t, e)) return p({ focusables: e, event: r });
    if (m || !r)
      return st(t, e);
  } else
  ...
  if (m && (r == null || r.preventDefault()), t) {
    if (ot(t, e)) return b({ focusables: e, event: r });
    if (m || !r)
      return nt(t, e);
  } else
