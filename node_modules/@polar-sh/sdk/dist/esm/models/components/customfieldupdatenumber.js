...
import { CustomFieldNumberProperties$outboundSchema, } from "./customfieldnumberproperties.js";
/** @internal */
export const CustomFieldUpdateNumberMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const CustomFieldUpdateNumber$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(CustomFieldNumberProperties$outboundSchema)),
});
