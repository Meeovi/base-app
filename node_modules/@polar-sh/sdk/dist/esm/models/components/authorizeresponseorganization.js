...
import { AuthorizeOrganization$inboundSchema, } from "./authorizeorganization.js";
import { OAuth2ClientPublic$inboundSchema, } from "./oauth2clientpublic.js";
import { Scope$inboundSchema } from "./scope.js";
/** @internal */
export const AuthorizeResponseOrganization$inboundSchema = z.pipe(z.object({
