...
/** @internal */
export const CustomerCreateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const CustomerCreate$outboundSchema = z.pipe(z.object({
    ...
    taxId: z.optional(z.nullable(z.array(z.nullable(z.union([z.string(), TaxIDFormat$outboundSchema]))))),
