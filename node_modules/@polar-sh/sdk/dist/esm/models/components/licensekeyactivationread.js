...
import { LicenseKeyRead$inboundSchema, } from "./licensekeyread.js";
/** @internal */
export const LicenseKeyActivationReadMeta$inboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const LicenseKeyActivationRead$inboundSchema = z.pipe(z.object({
    id: z.string(),
