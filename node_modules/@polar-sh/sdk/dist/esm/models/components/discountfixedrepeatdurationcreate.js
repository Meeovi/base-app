...
/** @internal */
export const DiscountFixedRepeatDurationCreateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const DiscountFixedRepeatDurationCreate$outboundSchema = z.pipe(z.object({
