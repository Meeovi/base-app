...
/** @internal */
export const CheckoutLinkUpdateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CheckoutLinkUpdate$outboundSchema = z.pipe(z.object({
