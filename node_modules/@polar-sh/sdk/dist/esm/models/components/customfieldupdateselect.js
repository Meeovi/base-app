...
import { CustomFieldSelectProperties$outboundSchema, } from "./customfieldselectproperties.js";
/** @internal */
export const CustomFieldUpdateSelectMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const CustomFieldUpdateSelect$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(CustomFieldSelectProperties$outboundSchema)),
});
