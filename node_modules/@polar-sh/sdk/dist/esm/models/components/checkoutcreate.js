...
/** @internal */
export const CheckoutCreateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CheckoutCreateCustomerMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const CheckoutCreate$outboundSchema = z.pipe(z.object({
    ...
    customerMetadata: z.optional(z.record(z.string(), z.union([z.string(), z.int(), z.number(), z.boolean()]))),
