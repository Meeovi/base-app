...
/** @internal */
export const CheckoutPrices$inboundSchema = z.union([
    LegacyRecurringProductPrice$inboundSchema,
    ProductPrice$inboundSchema,
]);
/** @internal */
export const CheckoutPrices$outboundSchema = z.union([
    LegacyRecurringProductPrice$outboundSchema,
    ProductPrice$outboundSchema,
]);
...
/** @internal */
export const CustomerMetadata$inboundSchema = z.union([z.string(), z.int(), z.boolean()]);
/** @internal */
export const CustomerMetadata$outboundSchema = z.union([z.string(), z.int(), z.boolean()]);
...
export const Checkout$inboundSchema = z.pipe(z.object({
    ...
    product_price: z.nullable(z.union([
        LegacyRecurringProductPrice$inboundSchema,
        ProductPrice$inboundSchema,
    ])),
    prices: z.nullable(z.record(z.string(), z.array(z.union([
        LegacyRecurringProductPrice$inboundSchema,
        ProductPrice$inboundSchema,
    ])))),
    ...
    customer_metadata: z.record(z.string(), z.union([z.string(), z.int(), z.boolean()])),
}), z.transform((v) => {
    return remap$(v, {
...
export const Checkout$outboundSchema = z.pipe(z.object({
    ...
    productPrice: z.nullable(z.union([
        LegacyRecurringProductPrice$outboundSchema,
        ProductPrice$outboundSchema,
    ])),
    prices: z.nullable(z.record(z.string(), z.array(z.union([
    ...
    customerMetadata: z.record(z.string(), z.union([z.string(), z.int(), z.boolean()])),
}), z.transform((v) => {
    return remap$(v, {
