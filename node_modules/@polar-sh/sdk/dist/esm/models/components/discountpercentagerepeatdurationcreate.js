...
/** @internal */
export const DiscountPercentageRepeatDurationCreateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const DiscountPercentageRepeatDurationCreate$outboundSchema = z.pipe(z.object({
