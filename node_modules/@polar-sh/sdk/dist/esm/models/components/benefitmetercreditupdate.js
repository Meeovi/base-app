...
import { BenefitMeterCreditCreateProperties$outboundSchema, } from "./benefitmetercreditcreateproperties.js";
/** @internal */
export const BenefitMeterCreditUpdateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const BenefitMeterCreditUpdate$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(BenefitMeterCreditCreateProperties$outboundSchema)),
});
