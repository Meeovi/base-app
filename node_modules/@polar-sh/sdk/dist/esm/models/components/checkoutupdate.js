...
/** @internal */
export const CheckoutUpdateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CheckoutUpdateCustomerMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const CheckoutUpdate$outboundSchema = z.pipe(z.object({
    ...
    customerMetadata: z.optional(z.nullable(z.record(z.string(), z.union([z.string(), z.int(), z.number(), z.boolean()])))),
