...
import { BenefitGitHubRepositoryCreateProperties$outboundSchema, } from "./benefitgithubrepositorycreateproperties.js";
/** @internal */
export const BenefitGitHubRepositoryUpdateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
export const BenefitGitHubRepositoryUpdate$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(BenefitGitHubRepositoryCreateProperties$outboundSchema)),
});
