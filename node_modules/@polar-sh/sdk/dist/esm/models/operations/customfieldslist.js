...
import { CustomFieldSortProperty$outboundSchema, } from "../components/customfieldsortproperty.js";
import { CustomFieldType$outboundSchema, } from "../components/customfieldtype.js";
import { ListResourceCustomField$inboundSchema, } from "../components/listresourcecustomfield.js";
/** @internal */
...
/** @internal */
export const CustomFieldsListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(CustomFieldSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const CustomFieldsListResponse$inboundSchema = z.pipe(z.object({
