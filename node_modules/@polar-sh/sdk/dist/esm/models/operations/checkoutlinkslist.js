...
import { CheckoutLinkSortProperty$outboundSchema, } from "../components/checkoutlinksortproperty.js";
import { ListResourceCheckoutLink$inboundSchema, } from "../components/listresourcecheckoutlink.js";
/** @internal */
...
/** @internal */
export const CheckoutLinksListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(CheckoutLinkSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const CheckoutLinksListResponse$inboundSchema = z.pipe(z.object({
