...
import { CustomerSubscriptionSortProperty$outboundSchema, } from "../components/customersubscriptionsortproperty.js";
import { ListResourceCustomerSubscription$inboundSchema, } from "../components/listresourcecustomersubscription.js";
/** @internal */
export const CustomerPortalSubscriptionsListSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalSubscriptionsListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(CustomerSubscriptionSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const CustomerPortalSubscriptionsListResponse$inboundSchema = z.pipe(z.object({
