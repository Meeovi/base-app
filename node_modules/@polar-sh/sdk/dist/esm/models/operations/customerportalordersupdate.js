...
import { CustomerOrderUpdate$outboundSchema, } from "../components/customerorderupdate.js";
/** @internal */
export const CustomerPortalOrdersUpdateSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalOrdersUpdateRequest$outboundSchema = z.pipe(z.object({
    id: z.string(),
