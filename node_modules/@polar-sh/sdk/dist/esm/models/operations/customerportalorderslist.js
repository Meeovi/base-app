...
import { CustomerOrderSortProperty$outboundSchema, } from "../components/customerordersortproperty.js";
import { ListResourceCustomerOrder$inboundSchema, } from "../components/listresourcecustomerorder.js";
import { ProductBillingType$outboundSchema, } from "../components/productbillingtype.js";
/** @internal */
export const CustomerPortalOrdersListSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalOrdersListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(CustomerOrderSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const CustomerPortalOrdersListResponse$inboundSchema = z.pipe(z.object({
