...
/** @internal */
export const CustomerPortalBenefitGrantsListQueryParamOrderIDFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
...
/** @internal */
export const QueryParamMemberIDFilter$outboundSchema = z.union([z.string(), z.array(z.string())]);
...
export const CustomerPortalBenefitGrantsListRequest$outboundSchema = z.pipe(z.object({
    ...
    memberId: z.optional(z.nullable(z.union([z.string(), z.array(z.string())]))),
