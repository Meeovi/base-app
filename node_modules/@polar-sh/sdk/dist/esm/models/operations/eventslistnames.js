...
import { EventNamesSortProperty$outboundSchema, } from "../components/eventnamessortproperty.js";
import { EventSource$outboundSchema, } from "../components/eventsource.js";
import { ListResourceEventName$inboundSchema, } from "../components/listresourceeventname.js";
/** @internal */
...
/** @internal */
export const EventsListNamesRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(EventNamesSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const EventsListNamesResponse$inboundSchema = z.pipe(z.object({
