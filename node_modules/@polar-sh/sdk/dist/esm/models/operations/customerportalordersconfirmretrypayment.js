...
import { CustomerOrderConfirmPayment$outboundSchema, } from "../components/customerorderconfirmpayment.js";
/** @internal */
export const CustomerPortalOrdersConfirmRetryPaymentSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalOrdersConfirmRetryPaymentRequest$outboundSchema = z.pipe(z.object({
    id: z.string(),
