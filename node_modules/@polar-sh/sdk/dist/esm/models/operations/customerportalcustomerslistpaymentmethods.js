...
import { ListResourceCustomerPaymentMethod$inboundSchema, } from "../components/listresourcecustomerpaymentmethod.js";
/** @internal */
export const CustomerPortalCustomersListPaymentMethodsSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalCustomersListPaymentMethodsResponse$inboundSchema = z
    .pipe(z.object({
