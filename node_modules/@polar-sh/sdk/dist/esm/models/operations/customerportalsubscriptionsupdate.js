...
import { CustomerSubscriptionUpdate$outboundSchema, } from "../components/customersubscriptionupdate.js";
/** @internal */
export const CustomerPortalSubscriptionsUpdateSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const CustomerPortalSubscriptionsUpdateRequest$outboundSchema = z.pipe(z.object({
    id: z.string(),
