...
import { CustomerMeterSortProperty$outboundSchema, } from "../components/customermetersortproperty.js";
import { ListResourceCustomerMeter$inboundSchema, } from "../components/listresourcecustomermeter.js";
/** @internal */
...
/** @internal */
export const CustomerMetersListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(CustomerMeterSortProperty$outboundSchema))),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const CustomerMetersListResponse$inboundSchema = z.pipe(z.object({
