...
import { EventSortProperty$outboundSchema, } from "../components/eventsortproperty.js";
import { EventSource$outboundSchema, } from "../components/eventsource.js";
import { ListResourceEvent$inboundSchema, } from "../components/listresourceevent.js";
import { ListResourceWithCursorPaginationEvent$inboundSchema, } from "../components/listresourcewithcursorpaginationevent.js";
...
/** @internal */
export const EventsListRequest$outboundSchema = z.pipe(z.object({
...
/** @internal */
export const EventsListResponseEventsList$inboundSchema = z.union([
    ListResourceEvent$inboundSchema,
    ListResourceWithCursorPaginationEvent$inboundSchema,
]);
export function eventsListResponseEventsListFromJSON(jsonString) {
    return safeParse(jsonString, (x) => EventsListResponseEventsList$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'EventsListResponseEventsList' from JSON`);
}
