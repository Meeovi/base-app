...
exports.CustomerPortalSubscriptionsListResponse$inboundSchema = exports.CustomerPortalSubscriptionsListRequest$outboundSchema = exports.CustomerPortalSubscriptionsListQueryParamProductIDFilter$outboundSchema = exports.CustomerPortalSubscriptionsListSecurity$outboundSchema = void 0;
...
/** @internal */
exports.CustomerPortalSubscriptionsListSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
exports.CustomerPortalSubscriptionsListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(customersubscriptionsortproperty_js_1.CustomerSubscriptionSortProperty$outboundSchema))),
}), z.transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
/** @internal */
exports.CustomerPortalSubscriptionsListResponse$inboundSchema = z.pipe(z.object({
