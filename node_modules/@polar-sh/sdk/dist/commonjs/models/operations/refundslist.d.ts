...
import { ListResourceRefund } from "../components/listresourcerefund.js";
...
/** @internal */
export declare const RefundIDFilter$outboundSchema: z.ZodMiniType<RefundIDFilter$Outbound, RefundIDFilter>;
...
/** @internal */
export declare const RefundsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<RefundsListQueryParamOrganizationIDFilter$Outbound, RefundsListQueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const OrderIDFilter$outboundSchema: z.ZodMiniType<OrderIDFilter$Outbound, OrderIDFilter>;
...
/** @internal */
export declare const SubscriptionIDFilter$outboundSchema: z.ZodMiniType<SubscriptionIDFilter$Outbound, SubscriptionIDFilter>;
...
/** @internal */
export declare const RefundsListQueryParamCustomerIDFilter$outboundSchema: z.ZodMiniType<RefundsListQueryParamCustomerIDFilter$Outbound, RefundsListQueryParamCustomerIDFilter>;
...
/** @internal */
export declare const RefundsListRequest$outboundSchema: z.ZodMiniType<RefundsListRequest$Outbound, RefundsListRequest>;
export declare function refundsListRequestToJSON(refundsListRequest: RefundsListRequest): string;
/** @internal */
export declare const RefundsListResponse$inboundSchema: z.ZodMiniType<RefundsListResponse, unknown>;
