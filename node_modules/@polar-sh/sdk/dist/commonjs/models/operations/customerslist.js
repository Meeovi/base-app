...
exports.CustomersListResponse$inboundSchema = exports.CustomersListRequest$outboundSchema = exports.CustomersListQueryParamOrganizationIDFilter$outboundSchema = void 0;
...
const listresourcecustomerwithmembers_js_1 = require("../components/listresourcecustomerwithmembers.js");
...
/** @internal */
exports.CustomersListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(customersortproperty_js_1.CustomerSortProperty$outboundSchema))),
...
/** @internal */
exports.CustomersListResponse$inboundSchema = z.pipe(z.object({
    Result: listresourcecustomerwithmembers_js_1.ListResourceCustomerWithMembers$inboundSchema,
}), z.transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        "Result": "result",
    });
