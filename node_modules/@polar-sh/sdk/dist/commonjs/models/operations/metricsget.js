...
exports.MetricsGetRequest$outboundSchema = exports.MetricsGetQueryParamCustomerIDFilter$outboundSchema = exports.QueryParamProductBillingTypeFilter$outboundSchema = exports.MetricsGetQueryParamProductIDFilter$outboundSchema = exports.MetricsGetQueryParamOrganizationIDFilter$outboundSchema = void 0;
...
/** @internal */
exports.MetricsGetRequest$outboundSchema = z.pipe(z.object({
    startDate: z.pipe(z.custom(x => x instanceof rfcdate_js_1.RFCDate), z.transform(v => v.toString())),
    endDate: z.pipe(z.custom(x => x instanceof rfcdate_js_1.RFCDate), z.transform(v => v.toString())),
    ...
    billingType: z.optional(z.nullable(z.union([
        productbillingtype_js_1.ProductBillingType$outboundSchema,
        z.array(productbillingtype_js_1.ProductBillingType$outboundSchema),
    ]))),
