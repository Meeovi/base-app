...
exports.CustomerPortalCustomerMetersListResponse$inboundSchema = exports.CustomerPortalCustomerMetersListRequest$outboundSchema = exports.MeterIDFilter$outboundSchema = exports.CustomerPortalCustomerMetersListSecurity$outboundSchema = void 0;
...
/** @internal */
exports.CustomerPortalCustomerMetersListSecurity$outboundSchema = z.pipe(z.object({
...
/** @internal */
exports.CustomerPortalCustomerMetersListRequest$outboundSchema = z.pipe(z.object({
    meterId: z.optional(z.nullable(z.union([z.string(), z.array(z.string())]))),
    query: z.optional(z.nullable(z.string())),
    page: z._default(z.int(), 1),
    limit: z._default(z.int(), 10),
    sorting: z.optional(z.nullable(z.array(customercustomermetersortproperty_js_1.CustomerCustomerMeterSortProperty$outboundSchema))),
}), z.transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        meterId: "meter_id",
    });
...
/** @internal */
exports.CustomerPortalCustomerMetersListResponse$inboundSchema = z.pipe(z.object({
