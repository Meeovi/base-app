...
exports.MetersListResponse$inboundSchema = exports.MetersListRequest$outboundSchema = exports.MetersListQueryParamOrganizationIDFilter$outboundSchema = void 0;
...
/** @internal */
exports.MetersListRequest$outboundSchema = z.pipe(z.object({
    ...
    sorting: z.optional(z.nullable(z.array(metersortproperty_js_1.MeterSortProperty$outboundSchema))),
...
/** @internal */
exports.MetersListResponse$inboundSchema = z.pipe(z.object({
