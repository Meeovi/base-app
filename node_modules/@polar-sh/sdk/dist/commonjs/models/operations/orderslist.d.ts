...
import { ListResourceOrder } from "../components/listresourceorder.js";
...
/** @internal */
export declare const OrdersListQueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<OrdersListQueryParamOrganizationIDFilter$Outbound, OrdersListQueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const OrdersListQueryParamProductIDFilter$outboundSchema: z.ZodMiniType<OrdersListQueryParamProductIDFilter$Outbound, OrdersListQueryParamProductIDFilter>;
...
/** @internal */
export declare const ProductBillingTypeFilter$outboundSchema: z.ZodMiniType<ProductBillingTypeFilter$Outbound, ProductBillingTypeFilter>;
...
/** @internal */
export declare const QueryParamDiscountIDFilter$outboundSchema: z.ZodMiniType<QueryParamDiscountIDFilter$Outbound, QueryParamDiscountIDFilter>;
...
/** @internal */
export declare const OrdersListQueryParamCustomerIDFilter$outboundSchema: z.ZodMiniType<OrdersListQueryParamCustomerIDFilter$Outbound, OrdersListQueryParamCustomerIDFilter>;
...
/** @internal */
export declare const CheckoutIDFilter$outboundSchema: z.ZodMiniType<CheckoutIDFilter$Outbound, CheckoutIDFilter>;
...
/** @internal */
export declare const OrdersListRequest$outboundSchema: z.ZodMiniType<OrdersListRequest$Outbound, OrdersListRequest>;
export declare function ordersListRequestToJSON(ordersListRequest: OrdersListRequest): string;
/** @internal */
export declare const OrdersListResponse$inboundSchema: z.ZodMiniType<OrdersListResponse, unknown>;
