...
/** @internal */
exports.CustomerUpdateExternalIDMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
exports.CustomerUpdateExternalID$outboundSchema = z.pipe(z.object({
    ...
    taxId: z.optional(z.nullable(z.array(z.nullable(z.union([z.string(), taxidformat_js_1.TaxIDFormat$outboundSchema]))))),
}), z.transform((v) => {
