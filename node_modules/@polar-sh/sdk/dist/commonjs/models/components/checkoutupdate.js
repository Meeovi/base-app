...
/** @internal */
exports.CheckoutUpdateMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
exports.CheckoutUpdateCustomerMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
