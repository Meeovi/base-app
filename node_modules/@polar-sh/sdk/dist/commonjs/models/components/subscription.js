...
exports.Subscription$outboundSchema = exports.Subscription$inboundSchema = exports.SubscriptionPrices$outboundSchema = exports.SubscriptionPrices$inboundSchema = exports.SubscriptionDiscount$outboundSchema = exports.SubscriptionDiscount$inboundSchema = exports.CustomFieldData$outboundSchema = exports.CustomFieldData$inboundSchema = void 0;
...
/** @internal */
exports.Subscription$inboundSchema = z.pipe(z.object({
    ...
    current_period_end: z.nullable(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    ...
    custom_field_data: z.optional(z.record(z.string(), z.nullable(z.union([
        z.string(),
        z.int(),
        z.boolean(),
        z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v))),
...
/** @internal */
exports.Subscription$outboundSchema = z.pipe(z.object({
    ...
    currentPeriodEnd: z.nullable(z.pipe(z.date(), z.transform(v => v.toISOString()))),
    ...
    customFieldData: z.optional(z.record(z.string(), z.nullable(z.union([
        z.string(),
        z.int(),
        z.boolean(),
        z.pipe(z.date(), z.transform(v => v.toISOString())),
