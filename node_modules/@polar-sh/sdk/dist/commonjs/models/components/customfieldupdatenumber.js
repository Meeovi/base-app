...
exports.CustomFieldUpdateNumber$outboundSchema = exports.CustomFieldUpdateNumberMetadata$outboundSchema = void 0;
...
/** @internal */
exports.CustomFieldUpdateNumberMetadata$outboundSchema = z.union([z.string(), z.int(), z.number(), z.boolean()]);
...
exports.CustomFieldUpdateNumber$outboundSchema = z.object({
    ...
    properties: z.optional(z.nullable(customfieldnumberproperties_js_1.CustomFieldNumberProperties$outboundSchema)),
});
