...
const walletslist_js_1 = require("../models/operations/walletslist.js");
...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(walletslist_js_1.WalletsListRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [(0, operations_js_1.haltIterator)(parsed), { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/wallets/")();
    ...
    const [result, raw] = await M.match(M.json(200, walletslist_js_1.WalletsListResponse$inboundSchema, { key: "Result" }), M.jsonErr(422, httpvalidationerror_js_1.HTTPValidationError$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => walletsList(client, {
            ...request,
            page: nextPage,
        }, options);
...
//# sourceMappingURL=walletsList.js.map