...
function es(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || s.content.size) {
      let o = es(i.content, s.content, t + 1);
      if (o != null)
        return o;
    }
    t += i.nodeSize;
...
function ts(n, e, t, r) {
  for (let i = n.childCount, s = e.childCount; ; ) {
    ...
    if (o.content.size || l.content.size) {
      let c = ts(o.content, l.content, t - 1, r - 1);
      if (c)
        return c;
    }
    t -= a, r -= a;
...
class x {
  ...
  */
  removeBetween(e, t) {
    return new x(ns(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function ns(n, e, t) {
  ...
  if (r != o)
    throw new RangeError("Removing non-flat range");
  return n.replaceChild(r, s.copy(ns(s.content, e - i - 1, t - i - 1)));
}
function rs(n, e, t, r) {
  let { index: i, offset: s } = n.findIndex(e), o = n.maybeChild(i);
  if (s == e || o.isText)
    return n.cut(0, e).append(t).append(n.cut(e));
  let l = rs(o.content, e - s - 1, t);
...
function St(n, e, t, r) {
  ...
  for (let l = s; l < o; l++)
    $e(i.child(l), r);
  e && e.depth == t && e.textOffset && $e(e.nodeBefore, r);
}
function We(n, e) {
  return n.type.checkContent(e), n.copy(e);
}
function ls(n, e, t, r, i) {
  let s = n.depth > i && qn(n, e, i + 1), o = r.depth > i && qn(t, r, i + 1), l = [];
  return St(null, n, i, l), s && o && e.index(i) == t.index(i) ? (ss(s, o), $e(We(s, ls(n, e, t, r, i + 1)), l)) : (s && $e(We(s, en(n, e, i + 1)), l), St(e, t, i, l), o && $e(We(o, en(t, r, i + 1)), l)), St(r, null, i, l), new y(l);
}
function en(n, e, t) {
  let r = [];
...
const _o = 12, vr = /* @__PURE__ */ new WeakMap();
class tn {
  /**
...
let Je = class Kn {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Zt(this.attrs, t || e.defaultAttrs || Xo) && N.sameSet(this.marks, r || N.none);
  }
  /**
  ...
  */
  copy(e = null) {
    return e == this.content ? this : new Kn(this.type, this.attrs, e, this.marks);
  }
  /**
  ...
  */
  mark(e) {
    return e == this.marks ? this : new Kn(this.type, this.attrs, this.content, e);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return jo(this.resolve(e), this.resolve(t), r);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), as(this.marks, e);
  }
  /**
...
class nn extends Je {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : as(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
function nl(n) {
  if (n.eat("(")) {
    ...
    let e = tl(n, n.next).map((t) => (n.inline == null ? n.inline = t.isInline : n.inline != t.isInline && n.err("Mixing inline and block content"), { type: "name", value: t }));
...
let Pr = class ms {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = ps(e, r.attrs), this.defaultAttrs = hs(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  computeAttrs(e) {
    return !e && this.defaultAttrs ? this.defaultAttrs : ds(this.attrs, e);
  }
  /**
  ...
  */
  checkAttrs(e) {
    us(this.attrs, e, "node", this.name);
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((s, o) => r[s] = new ms(s, t, o));
...
class ll {
  constructor(e, t, r) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default"), this.default = r.default, this.validate = typeof r.validate == "string" ? ol(e, t, r.validate) : r.validate;
  }
  get isRequired() {
...
class mn {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = ps(e, i.attrs), this.excluded = null;
    let s = hs(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new N(this, ds(this.attrs, e));
  }
  /**
  @internal
  */
  static compile(e, t) {
    ...
    return e.forEach((s, o) => r[s] = new mn(s, i++, t, o)), r;
  }
  /**
  ...
  */
  checkAttrs(e) {
    us(this.attrs, e, "mark", this.name);
  }
  /**
...
class al {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = B.from(e.nodes), t.marks = B.from(e.marks || {}), this.nodes = Pr.compile(this.spec.nodes, this), this.marks = mn.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new nn(r, r.defaultAttrs, e, N.setFrom(t));
  }
  /**
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      s && s.forEach((o) => {
        r(o = Hr(o)), o.mark || o.ignore || o.clearMark || (o.mark = i);
      });
    }
    for (let i in e.nodes) {
      let s = e.nodes[i].spec.parseDOM;
      s && s.forEach((o) => {
        r(o = Hr(o)), o.node || o.ignore || o.mark || (o.node = i);
      });
    }
    return t;
  }
...
class $t {
  ...
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !gs.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class Lr {
  constructor(e, t, r) {
    this.parser = e, this.options = t, this.isOpen = r, this.open = 0;
    let i = t.topNode, s, o = Fr(null, t.preserveWhitespace, 0) | (r ? Ct : 0);
    i ? s = new $t(i.type, i.attrs, N.none, !0, t.topMatch || i.type.contentMatch, o) : r ? s = new $t(null, null, N.none, !0, null, o) : s = new $t(e.schema.topNodeType, null, N.none, !0, null, o), this.nodes = [s], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
...
`), t);
  ...
  insertNode(e, t) {
    ...
    if (r) {
      ...
      for (let o of r.concat(e.marks))
        (i.type ? i.type.allowsMarkType(o.type) : $r(o.type, e.type)) && (s = o.addToSet(s));
  ...
  enterInner(e, t, r, i = !1, s) {
    ...
    let a = N.none;
    return r = r.filter((c) => (o.type ? o.type.allowsMarkType(c.type) : $r(c.type, e)) ? (a = c.addToSet(a), !1) : !0), this.nodes.push(new $t(e, t, a, i, null, l)), this.open++, r;
  }
...
function dl(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && ys.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function ul(n, e) {
...
class Ye {
  ...
  */
  serializeFragment(e, t = {}, r) {
    r || (r = Mn(t).createDocumentFragment());
    let i = r, s = [];
    return e.forEach((o) => {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = jt(Mn(t), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && jt(Mn(r), i(e, t), null, e.attrs);
  }
...
function pl(n) {
  let e = Jr.get(n);
  return e === void 0 && Jr.set(n, e = ml(n)), e;
}
function ml(n) {
  let e = null;
  function t(r) {
...
const bs = 65535, xs = Math.pow(2, 16);
function gl(n, e) {
  return n + e * xs;
}
function qr(n) {
...
class G {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= h) {
        ...
        if (r)
          return u;
        let p = e == (t < 0 ? a : h) ? null : gl(l / 3, e - a), m = e == a ? Ss : e == h ? ks : Ut;
        return (t < 0 ? e != a : e != h) && (m |= Cs), new jn(u, m, p);
      }
      i += f - c;
    }
  ...
  */
  touches(e, t) {
    let r = 0, i = qr(t), s = this.inverted ? 2 : 1, o = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
function dr(n, e, t) {
  ...
  for (let i = 0; i < n.childCount; i++) {
    let s = n.child(i);
    s.content.size && (s = s.copy(dr(s.content, e, s))), s.isInline && (s = e(s, t, i)), r.push(s);
  }
...
class Te extends W {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), s = new x(dr(t.content, (o, l) => !o.isAtom || !l.type.allowsMarkType(this.mark.type) ? o : o.mark(this.mark.addToSet(o.marks)), i), t.openStart, t.openEnd);
...
class le extends W {
  ...
  */
  ...
  apply(e) {
    let t = e.slice(this.from, this.to), r = new x(dr(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), t.openStart, t.openEnd);
...
class Ae extends W {
  ...
  */
  ...
  apply(e) {
    ...
    return R.fromReplace(e, this.pos, this.pos + 1, new x(y.from(r), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
  ...
  n.doc.nodesBetween(e, t, (a, c, f) => {
    ...
    if (!r.isInSet(h) && f.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < h.length; m++)
        h[m].isInSet(p) || (o && o.to == d && o.mark.eq(h[m]) ? o.to = u : i.push(o = new le(d, u, h[m])));
      l && l.to == d ? l.to = u : s.push(l = new Te(d, u, r));
    }
...
function ur(n, e, t, r = t.contentMatch, i = !0) {
  ...
  for (let a = 0; a < s.childCount; a++) {
    ...
    if (!h)
      ...
      for (let d = 0; d < c.marks.length; d++)
        t.allowsMarkType(c.marks[d].type) || n.step(new le(l, f, c.marks[d]));
...
function gn(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(s, o, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !kl(i, s, o))
      break;
  }
  return null;
}
...
function ws(n, e, t = null, r = n) {
  let i = Cl(n, e), s = i && wl(r, e);
  return s ? i.map(Kr).concat({ type: e, attrs: t }).concat(s.map(Kr)) : null;
}
function Kr(n) {
...
function Ol(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (o, l) => {
    ...
    if (o.isTextblock && !o.hasMarkup(r, a) && Nl(n.doc, n.mapping.slice(s).map(l), r)) {
      let c = null;
      if (r.schema.linebreakReplacement) {
        let u = r.whitespace == "pre", p = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        u && !p ? c = !1 : !u && p && (c = !0);
      }
      c === !1 && Os(n, o, l, s), ur(n, n.mapping.slice(s).map(l, 1), r, void 0, c === null);
      let f = n.mapping.slice(s), h = f.map(l, 1), d = f.map(l + o.nodeSize, 1);
      return n.step(new F(h, d, h + 1, d - 1, new x(y.from(r.create(a, null, o.marks)), 0, 0), 1, !0)), c === !0 && Ms(n, o, l, s), !1;
    }
  });
}
function Ms(n, e, t, r) {
...
function yn(n, e) {
  ...
  return El(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function Dl(n, e) {
...
function Rl(n, e, t) {
  ...
  if (r === !1) {
    ...
    Os(n, f.node(), f.before(), l);
  }
  o.inlineContent && ur(n, e + t - 1, o, s.node().contentMatchAt(s.index()), r == null);
  let a = n.mapping.slice(l), c = a.map(e - t);
  if (n.step(new H(c, a.map(e + t, -1), x.empty, !0)), r === !0) {
    let f = n.doc.resolve(c);
    Ms(n, f.node(), f.before(), n.steps.length);
  }
  return n;
}
function Il(n, e, t) {
...
function pr(n, e, t = e, r = x.empty) {
  if (e == t && !r.size)
    return null;
  let i = n.resolve(e), s = n.resolve(t);
  return Ns(i, s, r) ? new H(e, t, r) : new zl(i, s, r).fit();
}
function Ns(n, e, t) {
...
class zl {
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i, s = null;
        r ? (s = Nn(this.unplaced.content, r - 1).firstChild, i = s.content) : i = this.unplaced.content;
        let o = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced, i = Nn(e, t);
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: s }) {
    ...
    let o = this.unplaced, l = r ? r.content : o.content, a = o.openStart - e, c = 0, f = [], { match: h, type: d } = this.frontier[t];
    if (i) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (h = g, f.push(Ts(m.mark(d.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? u : -1)));
    }
  ...
  mustMoveInline() {
    ...
    if (!e.type.isTextblock || !Tn(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: r, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = Tn(e, t, i, r, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], f = Tn(e, l, c, a, !0);
          if (!f || f.childCount)
            continue e;
        }
...
function Ts(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, Ts(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(y.empty, !0)))), n.copy(r);
}
function Tn(n, e, t, r, i) {
  ...
  return l && !Bl(t, s.content, o) ? l : null;
}
function Bl(n, e, t) {
  ...
  for (let d = r.openStart; d >= 0; d--) {
    ...
    if (p)
      for (let m = 0; m < o.length; m++) {
        ...
        if (w.canReplaceWith(M, M, p.type, p.marks))
          return n.replace(i.before(g), b ? s.after(g) : t, new x(As(r.content, 0, r.openStart, u), u, r.openEnd));
      }
  }
...
function Fl(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = Il(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new x(y.from(r), 0, 0));
}
function Ll(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), s = Ds(r, i);
  for (let o = 0; o < s.length; o++) {
...
class ot extends W {
  ...
  */
  ...
  apply(e) {
    ...
    return R.fromReplace(e, this.pos, this.pos + 1, new x(y.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return G.empty;
  }
...
class S {
  ...
  */
  replace(e, t = x.empty) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      e.replaceRange(f.map(a.pos), f.map(c.pos), l ? x.empty : t), l == 0 && Gr(e, s, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, t) {
    ...
    for (let s = 0; s < i.length; s++) {
      ...
      s ? e.deleteRange(c, f) : (e.replaceRangeWith(c, f, t), Gr(e, r, t.isInline ? -1 : 1));
    }
  }
  /**
  ...
  */
  static findFrom(e, t, r = !1) {
    let i = e.parent.inlineContent ? new C(e) : et(e.node(0), e.parent, e.pos, e.index(), t, r);
    if (i)
      return i;
  ...
  */
  static atEnd(e) {
    return et(e, e, e.content.size, e.childCount, -1) || new X(e);
  }
  /**
...
class $l extends Es {
  ...
  */
  setSelection(e) {
    ...
    return this.curSelection = e, this.curSelectionFor = this.steps.length, this.updated = (this.updated | _r) & ~Wt, this.storedMarks = null, this;
  }
  /**
...
class kt {
  constructor(e, t, r) {
    this.name = e, this.init = Yr(t.init, r), this.apply = Yr(t.apply, r);
  }
}
const Wl = [
  new kt("doc", {
...
class Dn {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = Wl.slice(), t && t.forEach((r) => {
...
class nt {
  ...
  */
  applyInner(e) {
    ...
    let t = new nt(this.config), r = this.config.fields;
    for (let i = 0; i < r.length; i++) {
      let s = r[i];
  ...
  static fromJSON(e, t, r) {
    ...
    return i.fields.forEach((o) => {
      if (o.name == "doc")
        ...
        s.selection = S.fromJSON(s.doc, t.selection);
...
function Is(n, e, t) {
  for (let r in n) {
    let i = n[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = Is(i, e, {})), t[r] = i;
  }
  return t;
}
class ut {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && Is(e.props, this, this.props), this.key = e.key ? e.key.key : vs("plugin");
  }
  /**
...
function vs(n) {
  return n in En ? n + "$" + ++En[n] : (En[n] = 0, n + "$");
}
class vt {
  /**
  Create a plugin key.
...
const ql = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (ft(s, "end") || k.isSelectable(s)))
    for (let o = r.depth; ; o--) {
      let l = pr(n.doc, r.before(o), r.after(o), x.empty);
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = n.tr.step(l);
          a.setSelection(ft(s, "end") ? S.findFrom(a.doc.resolve(a.mapping.map(i.pos, -1)), -1) : k.create(a.doc, i.pos - s.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
const Ul = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (ft(s, "start") || k.isSelectable(s))) {
    let o = pr(n.doc, r.before(), r.after(), x.empty);
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = n.tr.step(o);
        l.setSelection(ft(s, "start") ? S.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : k.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const Vs = (n, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(r))
    return !1;
  let i = t.node(-1), s = t.indexAfter(-1), o = gr(i.contentMatchAt(s));
  ...
  if (t instanceof X || r.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let s = gr(i.parent.contentMatchAt(i.indexAfter()));
  if (!s || !s.isTextblock)
    return !1;
  if (e) {
...
function Ls(n) {
  return (e, t) => {
    ...
    if (e.selection instanceof k && e.selection.node.isBlock)
      return !r.parentOffset || !st(e.doc, r.pos) ? !1 : (t && t(e.tr.split(r.pos).scrollIntoView()), !0);
    if (!r.depth)
      return !1;
    let s = [], o, l, a = !1, c = !1;
    for (let u = r.depth; ; u--)
      if (r.node(u).isBlock) {
        a = r.end(u) == r.pos + (r.depth - u), c = r.start(u) == r.pos - (r.depth - u), l = gr(r.node(u - 1).contentMatchAt(r.indexAfter(u - 1)));
    ...
    let f = e.tr;
    (e.selection instanceof C || e.selection instanceof X) && f.deleteSelection();
    let h = f.mapping.map(r.pos), d = st(f.doc, h, s.length, s);
    if (d || (s[0] = l ? { type: l } : null, d = st(f.doc, h, s.length, s)), f.split(h, s.length, s), !a && c && r.node(o).type != l) {
...
const Yl = Ls(), Hs = (n, e) => (e && e(n.tr.setSelection(new X(n.doc))), !0);
function Zl(n, e, t) {
...
function $s(n, e, t, r) {
  ...
  let f = s.type.spec.isolating || r > 0 && a ? null : S.findFrom(e, 1), h = f && f.$from.blockRange(f.$to), d = h && gn(h);
  if (d != null && d >= e.depth)
    return t && t(n.tr.lift(h, d).scrollIntoView()), !0;
  if (c && ft(s, "start", !0) && ft(i, "end")) {
    let u = i, p = [];
...
const Ql = Ws(-1), ea = Ws(1);
function ta(n, e = null) {
  return function(t, r) {
    let i = !1;
...
function Pe(n, e = null, t) {
  ...
  return function(i, s) {
    ...
    if (o && !l || !na(i.doc, a, n, r))
      return !1;
    if (s)
      if (l)
        n.isInSet(i.storedMarks || l.marks()) ? s(i.tr.removeStoredMark(n)) : s(i.tr.addStoredMark(n.create(e)));
      else {
        let c, f = i.tr;
        ...
        for (let h = 0; h < a.length; h++) {
          ...
          if (!c)
            ...
            let p = d.pos, m = u.pos, g = d.nodeAfter, b = u.nodeBefore, w = g && g.isText ? /^\s*/.exec(g.text)[0].length : 0, M = b && b.isText ? /\s*$/.exec(b.text)[0].length : 0;
            p + w < m && (p += w, m -= M), f.addMark(p, m, n.create(e));
          }
        }
        s(f.scrollIntoView());
      }
...
let Rn = At(zs, ql, Kl), Zr = At(zs, Ul, Gl);
const ge = {
  Enter: At(_l, Xl, Fs, Yl),
  "Mod-Enter": Vs,
  Backspace: Rn,
  "Mod-Backspace": Rn,
  "Shift-Backspace": Rn,
...
for (let n in ge)
  Js[n] = ge[n];
const ra = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : typeof os < "u" && os.platform ? os.platform() == "darwin" : !1, ia = ra ? Js : ge;
...
v.from = function(e) {
  return e instanceof v ? e : e && e.length ? new qs(e) : v.empty;
};
...
class ie {
  ...
  popEvent(e, t) {
    ...
    return this.items.forEach((h, d) => {
      ...
      if (i) {
        ...
        o.maybeStep(h.step);
      if (h.selection)
        return l = i ? h.selection.map(i.slice(s)) : h.selection, a = new ie(this.items.slice(0, r).append(f.reverse().concat(c)), this.eventCount - 1), !1;
  ...
  addTransform(e, t, r, i) {
    ...
    let c = o - r.depth;
    return c > aa && (l = la(l, c), o -= c), new ie(l.append(s), o);
  }
  remapping(e, t) {
    let r = new it();
  ...
  addMaps(e) {
    return this.eventCount == 0 ? this : new ie(this.items.append(e.map((t) => new oe(t))), this.eventCount);
  }
  ...
  rebased(e, t) {
    ...
    let c = [];
    for (let d = t; d < o; d++)
      c.push(new oe(s.maps[d]));
    let f = this.items.slice(0, i).append(c).append(r), h = new ie(f, l);
    return h.emptyItemCount() > oa && (h = h.compress(this.items.length - r.length)), h;
  }
  emptyItemCount() {
    let e = 0;
  ...
  compress(e = this.items.length) {
    ...
    }, this.items.length, 0), new ie(v.from(i.reverse()), s);
  }
}
...
function ca(n, e, t, r) {
  ...
  t.getMeta(da) && (n = new we(n.done, n.undone, null, 0, -1));
  let o = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (o && o.getMeta(qe))
    return o.getMeta(qe).redo ? new we(n.done.addTransform(t, void 0, r, Gt(e)), n.undone, Qr(t.mapping.maps), n.prevTime, n.prevComposition) : new we(n.done, n.undone.addTransform(t, void 0, r, Gt(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(o && o.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !o && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !fa(t, n.prevRanges)), c = o ? In(n.prevRanges, t.mapping) : Qr(t.mapping.maps);
    return new we(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, Gt(e)), ie.empty, c, t.time, l ?? n.prevComposition);
  } else return (s = t.getMeta("rebased")) ? new we(n.done.rebased(t, s), n.undone.rebased(t, s), In(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new we(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), In(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function fa(n, e) {
  if (!e)
    return !1;
...
const qe = new vt("history"), da = new vt("closeHistory");
function ua(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? js : r == "historyRedo" ? Gn : null;
...
var ve = {
  ...
  221: "}",
  222: '"'
}, pa = typeof navigator < "u" && /Mac/.test(navigator.platform), ma = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
for (var zn in ve) ln.hasOwnProperty(zn) || (ln[zn] = ve[zn]);
function ga(n) {
  var e = pa && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || ma && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? ln : ve)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const ya = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function ba(n) {
...
function ti(n, e = null) {
  return function(t, r) {
    ...
    let c = ws(a, n, e, o);
    return c ? (r && r(ka(t.tr, o, c, l, n).scrollIntoView()), !0) : !1;
  };
}
...
function Sa(n, e) {
  return function(t, r) {
    ...
    return st(c.doc, i.pos, 2, f) ? (r && r(c.split(i.pos, 2, f).scrollIntoView()), !0) : !1;
  };
}
function _n(n) {
  return function(e, t) {
    let { $from: r, $to: i } = e.selection, s = r.blockRange(i, (o) => o.childCount > 0 && o.firstChild.type == n);
    return s ? t ? r.node(s.depth - 1).type == n ? Ca(e, t, n, s) : wa(e, t, s) : !0 : !1;
  };
}
function Ca(n, e, t, r) {
  let i = n.tr, s = r.end, o = r.$to.end(r.depth);
  s < o && (i.step(new F(s - 1, o, s, o, new x(y.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new tn(i.doc.resolve(r.$from.pos), i.doc.resolve(o), r.depth));
  const l = gn(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
const me = function(n, e, t) {
  let r = Xn || (Xn = document.createRange());
  return r.setEnd(n, t ?? n.nodeValue.length), r.setStart(n, e || 0), r;
}, Oa = function() {
  Xn = null;
}, _e = function(n, e, t, r) {
  return t && (ni(n, e, t, r, -1) || ni(n, e, t, r, 1));
...
function ni(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : te(n))) {
      let s = n.parentNode;
      if (!s || s.nodeType != 1 || zt(n) || Na.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = V(n) + (i < 0 ? 0 : 1), n = s;
...
const ae = typeof navigator < "u" ? navigator : null, ri = typeof document < "u" ? document : null, ze = ae && ae.userAgent || "", Yn = /Edge\/(\d+)/.exec(ze), Gs = /MSIE \d/.exec(ze), Zn = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(ze), U = !!(Gs || Zn || Yn), Ee = Gs ? document.documentMode : Zn ? +Zn[1] : Yn ? +Yn[1] : 0, se = !U && /gecko\/(\d+)/i.test(ze);
se && +(/Firefox\/(\d+)/.exec(ze) || [0, 0])[1];
const Qn = !U && /Chrome\/(\d+)/.exec(ze), $ = !!Qn, _s = Qn ? +Qn[1] : 0, J = !U && !!ae && /Apple Computer/.test(ae.vendor), ht = J && (/Mobile\/\w+/.test(ze) || !!ae && ae.maxTouchPoints > 2), ee = ht || (ae ? /Mac/.test(ae.platform) : !1), Ia = ae ? /Win/.test(ae.platform) : !1, re = /Android \d/.test(ze), Bt = !!ri && "webkitFontSmoothing" in ri.documentElement.style, va = Bt ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function za(n) {
...
function ii(n, e, t) {
  ...
  for (let o = t || n.dom; o; o = Dt(o)) {
    if (o.nodeType != 1)
      continue;
    let l = o, a = l == s.body, c = a ? za(s) : Ba(l), f = 0, h = 0;
    if (e.top < c.top + he(r, "top") ? h = -(c.top - e.top + he(i, "top")) : e.bottom > c.bottom - he(r, "bottom") && (h = e.bottom - e.top > c.bottom - c.top ? e.top + he(i, "top") - c.top : e.bottom - c.bottom + he(i, "bottom")), e.left < c.left + he(r, "left") ? f = -(c.left - e.left + he(i, "left")) : e.right > c.right - he(r, "right") && (f = e.right - c.right + he(i, "right")), f || h)
      if (a)
...
function Pa(n) {
  ...
  return { refDOM: r, refTop: i, stack: Xs(n.dom) };
}
function Xs(n) {
...
function Zs(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? La(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: s } : Zs(t, i);
}
function La(n, e) {
...
function $a(n, e, t) {
  let { node: r, offset: i } = Zs(e, t), s = -1;
...
function Ja(n, e) {
  ...
  if (o = Ha(o, e), r) {
    ...
    let c;
    Bt && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = Wa(n, r, i, e));
  }
  l == null && (l = $a(n, o, e));
...
function eo(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (o && (qa.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Ce(me(r, i, i), t);
      if (se && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let c = Ce(me(r, i - 1, i - 1), -1);
        if (c.top == a.top) {
          let f = Ce(me(r, i, i + 1), -1);
          if (f.top != a.top)
      ...
      return t < 0 && !i ? (c++, f = -1) : t >= 0 && i == r.nodeValue.length ? (a--, f = 1) : t < 0 ? a-- : c++, pt(Ce(me(r, a, c), f), f < 0);
    }
  if (!n.state.doc.resolve(e - (s || 0)).parent.inlineContent) {
    if (s == null && i && (t < 0 || i == te(r))) {
      let a = r.childNodes[i - 1];
      if (a.nodeType == 1)
        return Vn(a.getBoundingClientRect(), !1);
    }
    if (s == null && i < te(r)) {
      let a = r.childNodes[i];
      if (a.nodeType == 1)
        return Vn(a.getBoundingClientRect(), !0);
    }
    return Vn(r.getBoundingClientRect(), t >= 0);
  }
  if (s == null && i && (t < 0 || i == te(r))) {
  ...
  return pt(Ce(r.nodeType == 3 ? me(r) : r, -t), t >= 0);
}
function pt(n, e) {
  if (n.width == 0)
    return n;
...
function Ua(n, e, t) {
  ...
  return l ? !ja.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? s : o : to(n, e, () => {
...
function Ga(n, e, t) {
  return oi == e && li == t ? ai : (oi = e, li = t, ai = t == "up" || t == "down" ? Ka(n, e, t) : Ua(n, e, t));
}
...
class Pt {
  ...
  domFromPos(e, t) {
    ...
    for (let s; r && !(s = this.children[r - 1]).size && s instanceof no && s.side >= 0; r--)
      ;
    if (t <= 0) {
      let s, o = !0;
  ...
  setSelection(e, t, r, i = !1) {
    ...
    let l = this.domFromPos(e, e ? -1 : 1), a = t == e ? l : this.domFromPos(t, t ? -1 : 1), c = r.root.getSelection(), f = r.domSelectionRange(), h = !1;
    if ((se || J) && e == t) {
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == o ? e <= o && t >= r : e < o && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == o ? Fe : ci, e == l && t == a && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = ce : s.markDirty(e - l, t - l);
          return;
        } else
          s.dirty = s.dom == s.contentDOM && s.dom.parentNode == this.contentDOM && !s.children.length ? Fe : ce;
      }
      r = o;
    }
    this.dirty = Fe;
...
class Xe extends Pt {
  ...
  static create(e, t, r, i) {
    ...
    return (!o || !o.dom) && (o = Ye.renderSpec(document, t.type.spec.toDOM(t, r), null, t.attrs)), new Xe(e, t, o.dom, o.contentDOM || o.dom, o);
  }
  parseRule() {
  ...
  slice(e, t, r) {
    let i = Xe.create(this.parent, this.mark, !0, r), s = this.children, o = this.size;
    t < o && (s = tr(s, t, o, r)), e > 0 && (s = tr(s, 0, e, r));
...
class Re extends Pt {
  ...
  static create(e, t, r, i, s, o) {
    ...
    let d = f;
    return f = oo(f, r, t), c ? a = new Xa(e, t, r, i, f, h || null, d, c, s, o + 1) : t.isText ? new kn(e, t, r, i, f, d, s) : new Re(e, t, r, i, f, h || null, d, s, o + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, s = e.composing ? this.localCompositionInfo(e, t) : null, o = s && s.pos > -1 ? s : null, l = s && s.pos < 0, a = new Za(this, o && o.node, e);
    tc(this.node, this.innerDeco, (c, f, h) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == Fe) && (o && this.protectLocalComposition(e, o), io(this.contentDOM, this.children, e), ht && nc(this.dom));
  }
  localCompositionInfo(e, t) {
    let { from: r, to: i } = e.state.selection;
    if (!(e.state.selection instanceof C) || r < t || i > t + this.node.content.size)
      return null;
    let s = e.input.compositionNode;
    if (!s || !this.dom.contains(s.parentNode))
      return null;
    if (this.node.inlineContent) {
      let o = s.nodeValue, l = rc(this.node.content, o, r - t, i - t);
  ...
  protectLocalComposition(e, { node: t, pos: r, text: i }) {
    ...
    let o = new _a(this, s, t, i);
    e.input.compositionNodes.push(o), this.children = tr(this.children, r, r + i.length, e, o);
  }
  ...
  updateOuterDeco(e) {
    ...
    this.dom = so(this.dom, this.nodeDOM, er(this.outerDeco, this.node, t), er(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class kn extends Re {
  ...
  update(e, t, r, i) {
    return this.dirty == ce || this.dirty != ne && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != ne || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, i.trackWrites == this.nodeDOM && (i.trackWrites = null)), this.node = e, this.dirty = ne, !0);
  }
  inParent() {
  ...
  slice(e, t, r) {
    ...
    return new kn(this.parent, i, this.outerDeco, this.innerDeco, s, s, r);
  }
  markDirty(e, t) {
...
function io(n, e, t) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    if (o instanceof Xe) {
      ...
      io(o.contentDOM, o.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = hi(r), i = !0;
...
function oo(n, e, t) {
  return so(n, n, Le, er(e, t, n.nodeType != 1));
}
function an(n, e) {
  if (n.length != e.length)
    return !1;
...
class Za {
  ...
  syncToMarks(e, t, r) {
    ...
    for (; s < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = Xe.create(this.top, e[s], t, r);
  ...
  updateNodeAt(e, t, r, i, s) {
    ...
    return o.dirty == ce && o.dom == o.contentDOM && (o.dirty = Fe), o.update(e, t, r, s) ? (this.destroyBetween(this.index, i), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, t, r, i, s, o) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Re) {
        ...
        if (c != null && c != s)
          return !1;
        let f = a.dom, h, d = this.isLocked(f) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != ce && an(t, a.outerDeco));
...
function br(n, e = null) {
  ...
  if (xn(t)) {
    for (a = o; i && !i.node; )
      i = i.parent;
    let h = i.node;
    if (i && h.isAtom && k.isSelectable(h) && i.parent && !(h.isInline && Da(t.focusNode, t.focusOffset, i.dom))) {
      let d = i.posBefore;
...
function be(n, e = !1) {
  ...
  if (ao(n, t), !!lo(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      di && !(t instanceof C) && (t.$from.parent.inlineContent || (s = ui(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (o = ui(n, t.to))), n.docView.setSelection(r, i, n, e), di && (s && pi(s), o && pi(o)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ic(n));
    }
...
function ic(n) {
  ...
  e.addEventListener("selectionchange", n.input.hideSelectionGuard = () => {
    (t.anchorNode != r || t.anchorOffset != i) && (e.removeEventListener("selectionchange", n.input.hideSelectionGuard), setTimeout(() => {
      (!lo(n) || n.state.selection.visible) && n.dom.classList.remove("ProseMirror-hideselection");
    }, 20));
  });
}
function sc(n) {
...
function ao(n, e) {
  if (e instanceof k) {
    ...
    t != n.lastSelectedViewDesc && (mi(n), t && t.selectNode(), n.lastSelectedViewDesc = t);
  } else
    mi(n);
}
function mi(n) {
  ...
  if (r instanceof C)
    if (t.indexOf("s") > -1) {
      ...
      if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
        ...
        return s.isAtom || (o = n.docView.descAt(l)) && !o.contentDOM ? k.isSelectable(s) ? Me(n, new k(e < 0 ? n.state.doc.resolve(i.pos - s.nodeSize) : i)) : Bt ? Me(n, new C(n.state.doc.resolve(e < 0 ? l : l + s.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
    if (r instanceof k && r.node.isInline)
      return Me(n, new C(e > 0 ? r.$to : r.$from));
    {
      let i = nr(n.state, e);
      return i ? Me(n, i) : !1;
    }
...
function rr(n, e, t) {
  if (e.nodeType != 3) {
    let s, o;
    (o = cc(e, t)) ? (e = o, t = 0) : (s = fc(e, t)) && (e = s, t = s.nodeValue.length);
  }
...
function xi(n, e, t) {
  let r = n.state.selection;
  if (r instanceof C && !r.empty || t.indexOf("s") > -1 || ee && t.indexOf("m") > -1)
    return !1;
  let { $from: i, $to: s } = r;
  ...
  if (!i.parent.inlineContent) {
    let o = e < 0 ? i : s, l = r instanceof X ? S.near(o, e) : S.findFrom(o, e);
    return l ? Me(n, l) : !1;
  }
  return !1;
}
...
function hc(n) {
  ...
  if (e && e.nodeType == 1 && t == 0 && e.firstChild && e.firstChild.contentEditable == "false") {
    let r = e.firstChild;
    Si(n, r, "true"), setTimeout(() => Si(n, r, "false"), 20);
  }
  return !1;
}
function dc(n) {
...
function ho(n, e) {
  ...
  let o = n.someProp("clipboardSerializer") || Ye.fromSchema(n.state.schema), l = bo(), a = l.createElement("div");
  a.appendChild(o.serializeFragment(r, { document: l }));
  let c = a.firstChild, f, h = 0;
  for (; c && c.nodeType == 1 && (f = yo[c.nodeName.toLowerCase()]); ) {
...
`))), 0, 0) : x.empty;
    ...
    if (h)
      ...
      let d = i.marks(), { schema: u } = n.state, p = Ye.fromSchema(u);
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Ge.fromSchema(n.state.schema)).parseSlice(o, {
    ...
    context: i,
    ruleFromNode(d) {
      return d.nodeName == "BR" && !d.nextSibling && d.parentNode && !pc.test(d.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), f)
    l = xc(Ci(l, +f[1], +f[2]), f[4]);
  else if (l = x.maxOpen(mc(l.content, i), !0), l.openStart || l.openEnd) {
    let h = 0, d = 0;
...
const pc = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function mc(n, e) {
  if (n.childCount < 2)
    return n;
  for (let t = e.depth; t >= 0; t--) {
...
function mo(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    ...
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(y.from(po(t, n, i + 1))));
  }
}
function go(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, go(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(y.empty, !0);
  return n.copy(t.append(r));
}
function ir(n, e, t, r, i, s) {
  let o = e < 0 ? n.firstChild : n.lastChild, l = o.content;
  return n.childCount > 1 && (s = 0), i < r - 1 && (l = ir(l, e, t, r, i + 1, s)), i >= t && (l = e < 0 ? o.contentMatchAt(0).fillBefore(l, s <= i).append(l) : l.append(o.contentMatchAt(o.childCount).fillBefore(y.empty, !0))), n.replaceChild(e < 0 ? 0 : n.childCount - 1, o.copy(l));
}
function Ci(n, e, t) {
  return e < n.openStart && (n = new x(ir(n.content, -1, e, n.openStart, 0, n.openEnd), e, n.openEnd)), t < n.openEnd && (n = new x(ir(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)), n;
}
const yo = {
  thead: ["table"],
  tbody: ["table"],
...
function gc(n) {
  ...
  return e ? (Ln || (Ln = e.createPolicy("ProseMirrorClipboard", { createHTML: (t) => t })), Ln.createHTML(n)) : n;
}
function yc(n) {
  let e = /^(\s*<meta [^>]*>)*/.exec(n);
  e && (n = n.slice(e[0].length));
  let t = bo().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && yo[r[1].toLowerCase()]) && (n = i.map((s) => "<" + s + ">").join("") + n + i.map((s) => "</" + s + ">").reverse().join("")), t.innerHTML = gc(n), i)
    for (let s = 0; s < i.length; s++)
...
const q = {}, K = {}, kc = { touchstart: !0, touchmove: !0 };
class Sc {
  constructor() {
...
function Cc(n) {
  for (let e in q) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Mc(n, r) && !kr(n, r) && (n.editable || !(r.type in K)) && t(n, r);
    }, kc[e] ? { passive: !0 } : void 0);
  }
  J && n.dom.addEventListener("input", () => null), sr(n);
}
function De(n, e) {
...
function Oc(n, e) {
  !kr(n, e) && q[e.type] && (n.editable || !(e.type in K)) && q[e.type](n, e);
}
K.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !ko(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(re && $ && t.keyCode == 13)))
    ...
    } else n.someProp("handleKeyDown", (r) => r(n, t)) || uc(n, t) ? t.preventDefault() : De(n, "key");
};
K.keyup = (n, e) => {
...
K.keypress = (n, e) => {
  let t = e;
  if (ko(n, t) || !t.charCode || t.ctrlKey && !t.altKey || ee && t.metaKey)
    return;
...
function Tc(n, e) {
  ...
  return r && r.isAtom && k.isSelectable(r) ? (lt(n, new k(t)), !0) : !1;
}
function Ac(n, e) {
  if (e == -1)
    return !1;
  ...
  return i != null ? (lt(n, k.create(n.state.doc, i)), !0) : !1;
}
function Dc(n, e, t, r, i) {
  return Sr(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (s) => s(n, e, r)) || (i ? Ac(n, t) : Tc(n, t));
}
function Ec(n, e, t, r) {
  return Sr(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function Rc(n, e, t, r) {
  return Sr(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Ic(n, t, r);
}
function Ic(n, e, t) {
  if (t.button != 0)
    return !1;
  let r = n.state.doc;
  if (e == -1)
    return r.inlineContent ? (lt(n, C.create(r, 0, r.content.size)), !0) : !1;
  let i = r.resolve(e);
  for (let s = i.depth + 1; s > 0; s--) {
    let o = s > i.depth ? i.nodeAfter : i.node(s), l = i.before(s);
    if (o.inlineContent)
      lt(n, C.create(r, l + 1, l + 1 + o.content.size));
...
const xo = ee ? "metaKey" : "ctrlKey";
q.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = Cr(n), i = Date.now(), s = "singleClick";
  i - n.input.lastClick.time < 500 && Nc(t, n.input.lastClick) && !t[xo] && (n.input.lastClick.type == "singleClick" ? s = "doubleClick" : n.input.lastClick.type == "doubleClick" && (s = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: s };
  let o = n.posAtCoords(Sn(t));
  o && (s == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new vc(n, o, t, !!r)) : (s == "doubleClick" ? Ec : Rc)(n, o.pos, o.inside, t) ? t.preventDefault() : De(n, "pointer"));
};
class vc {
  constructor(e, t, r, i) {
    this.view = e, this.pos = t, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[xo], this.allowDefault = r.shiftKey;
    let s, o;
    if (t.inside > -1)
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Sn(e))), this.updateAllowDefault(e), this.allowDefault || !t ? De(this.view, "pointer") : Dc(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    $ && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (lt(this.view, S.near(this.view.state.doc.resolve(t.pos))), e.preventDefault()) : De(this.view, "pointer");
  }
  move(e) {
...
q.touchstart = (n) => {
  n.input.lastTouch = Date.now(), Cr(n), De(n, "pointer");
};
q.touchmove = (n) => {
  n.input.lastTouch = Date.now(), De(n, "pointer");
};
q.contextmenu = (n) => Cr(n);
function ko(n, e) {
...
K.compositionend = (n, e) => {
  n.composing && (n.input.composing = !1, n.input.compositionEndedAt = e.timeStamp, n.input.compositionPendingChanges = n.domObserver.pendingRecords().length ? n.input.compositionID : 0, n.input.compositionNode = null, n.input.compositionPendingChanges && Promise.resolve().then(() => n.domObserver.flush()), n.input.compositionID++, So(n, 20));
};
function So(n, e) {
...
function Bc(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = Ta(e.focusNode, e.focusOffset), r = Aa(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
...
function fn(n, e = !1) {
  if (!(re && n.domObserver.flushingSoon >= 0)) {
    if (n.domObserver.forceFlush(), Co(n), e || n.docView && n.docView.dirty) {
      let t = br(n);
...
const Et = U && Ee < 15 || ht && va < 604;
q.copy = K.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let s = Et ? null : t.clipboardData, o = r.content(), { dom: l, text: a } = ho(n, o);
...
function Rt(n, e, t, r, i) {
  let s = uo(n, e, t, r, n.state.selection.$from);
...
K.paste = (n, e) => {
  ...
  r && Rt(n, wo(r), r.getData("text/html"), i, t) ? t.preventDefault() : Lc(n, t);
};
class Mo {
  constructor(e, t, r) {
...
q.dragstart = (n, e) => {
  ...
  if (r && r.done(), !t.dataTransfer)
    return;
  let i = n.state.selection, s = i.empty ? null : n.posAtCoords(Sn(t)), o;
  ...
  let l = (o || n.state.selection).content(), { dom: a, text: c, slice: f } = ho(n, l);
  (!t.dataTransfer.files.length || !$ || _s > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Et ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Et || t.dataTransfer.setData("text/plain", c), n.dragging = new Mo(f, !t[Oo], o);
};
q.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
K.drop = (n, e) => {
  ...
  if (n.dragging = null, !t.dataTransfer)
    return;
  let i = n.posAtCoords(Sn(t));
  if (!i)
    return;
  let s = n.state.doc.resolve(i.pos), o = r && r.slice;
  o ? n.someProp("transformPasted", (p) => {
    o = p(o, n);
  }) : o = uo(n, wo(t.dataTransfer), Et ? null : t.dataTransfer.getData("text/html"), !1, s);
  let l = !!(r && !t[Oo]);
  ...
  if (h && k.isSelectable(o.content.firstChild) && u.nodeAfter && u.nodeAfter.sameMarkup(o.content.firstChild))
    ...
    c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, b, w) => p = w), c.setSelection(xr(n, u, c.doc.resolve(p)));
  }
...
class wr {
  ...
  eq(e) {
    return this == e || e instanceof wr && It(this.attrs, e.attrs) && It(this.spec, e.spec);
  }
  destroy() {
  }
}
...
class A {
  ...
  */
  mapInner(e, t, r, i, s) {
    ...
    return this.children.length ? Hc(this.children, o || [], e, t, r, i, s) : o ? new A(o.sort(je), tt) : L;
  }
  /**
...
class Oe {
  ...
  map(e, t) {
    const r = this.members.map((i) => i.map(e, t, Ke));
    return Oe.from(r);
  }
  forChild(e, t) {
    if (t.isLeaf)
  ...
  eq(e) {
    if (!(e instanceof Oe) || e.members.length != this.members.length)
      return !1;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Oe(e.every((t) => t instanceof A) ? e : e.reduce((t, r) => t.concat(r instanceof A ? r : r.members), []));
    }
  }
  forEachSet(e) {
    for (let t = 0; t < this.members.length; t++)
...
function Hc(n, e, t, r, i, s, o) {
    ...
    t.maps[c].forEach((d, u, p, m) => {
      ...
      for (let b = 0; b < l.length; b += 3) {
        ...
        if (w < 0 || d > w + f - h)
          continue;
        let M = l[b] + f - h;
        u >= M ? l[b + 1] = d <= M ? -2 : -1 : d >= f && g && (l[b] += g, l[b + 1] += g);
      }
      h += g;
    }), f = t.maps[c].map(f, -1);
  }
  ...
  if (a) {
    let c = $c(l, n, e, t, i, s, o), f = dn(c, r, 0, o);
    e = f.local;
  ...
  for (let t = 0; t < e.length - 1; t++) {
    ...
    if (r.from != r.to)
      for (let i = t + 1; i < e.length; i++) {
        let s = e[i];
        if (s.from == r.from) {
          s.to != r.to && (e == n && (e = n.slice()), e[i] = s.copy(s.from, r.to), Mi(e, i + 1, s.copy(r.to, s.to)));
          continue;
        } else {
          s.from < r.to && (e == n && (e = n.slice()), e[t] = r.copy(r.from, s.from), Mi(e, i, r.copy(s.from, r.to)));
          break;
        }
      }
  }
...
class Kc {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new qc(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  flush() {
    ...
    t.length && (this.queue = []);
    let r = e.domSelectionRange(), i = !this.suppressingSelectionUpdates && !this.currentSelection.eq(r) && gi(e) && !this.ignoreSelectionChange(r), s = -1, o = -1, l = !1, a = [];
    if (e.editable)
      for (let f = 0; f < t.length; f++) {
    ...
    if (se && a.length) {
      ...
      if (f.length == 2) {
        ...
        for (let d of f) {
          let u = d.parentNode;
          u && u.nodeName == "LI" && (!h || Gc(e, h) != u) && d.remove();
        }
      }
    }
    let c = null;
    s < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && xn(r) && (c = br(e)) && c.eq(S.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, be(e), this.currentSelection.set(r), e.scrollToSelection()) : (s > -1 || i) && (s > -1 && (e.docView.markDirty(s, o), jc(e)), this.handleDOMChange(s, o, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || be(e), this.currentSelection.set(r));
  }
...
function _c(n, e, t) {
  ...
  if (f && n.dom.contains(f.nodeType == 1 ? f : f.parentNode) && (c = [{ node: f, offset: a.anchorOffset }], xn(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), $ && n.input.lastKeyCode === 8)
    for (let g = s; g > i; g--) {
  ...
  let h = n.state.doc, d = n.someProp("domParser") || Ge.fromSchema(n.state.schema), u = h.resolve(o), p = null, m = d.parse(r, {
    topNode: u.parent,
...
const Yc = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Zc(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (Se && !n.state.selection.eq(Se)) {
      if ($ && re && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (Ko) => Ko(n, Ve(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = _c(n, e, t), f = n.state.doc, h = f.slice(c.from, c.to), d, u;
  ...
  let p = tf(h.content, c.doc.content, c.from, d, u);
  if (p && n.input.domChangeCount++, (ht && n.input.lastIOSEnter > Date.now() - 225 || re) && i.some((O) => O.nodeType == 1 && !Yc.test(O.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (O) => O(n, Ve(13, "Enter")))) {
    n.input.lastIOSEnter = 0;
    return;
  }
  if (!p)
    if (r && a instanceof C && !a.empty && a.$head.sameParent(a.$anchor) && !n.composing && !(c.sel && c.sel.anchor != c.sel.head))
      p = { start: a.from, endA: a.to, endB: a.to };
    else {
      if (c.sel) {
        let O = Ai(n, n.state.doc, c.sel);
  ...
  if (n.state.selection.anchor > p.start && ef(f, p.start, p.endA, m, g) && n.someProp("handleKeyDown", (O) => O(n, Ve(8, "Backspace")))) {
  ...
  if (w) {
    if (m.pos == g.pos)
      ...
      p.endA == p.endB && (ke = Qc(m.parent.content.cut(m.parentOffset, g.parentOffset), b.parent.content.cut(b.parentOffset, p.endA - b.start())))
    )
      D = n.state.tr, ke.type == "add" ? D.addMark(T, I, ke.mark) : D.removeMark(T, I, ke.mark);
    else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
      let O = m.parent.textBetween(m.parentOffset, g.parentOffset);
      if (n.someProp("handleTextInput", (Se) => Se(n, T, I, O)))
        return;
      D = n.state.tr.insertText(O, T, I);
    }
  }
...
function Ai(n, e, t) {
  return Math.max(t.anchor, t.head) > e.content.size ? null : xr(n, e.resolve(t.anchor), e.resolve(t.head));
}
function Qc(n, e) {
...
function ef(n, e, t, r, i) {
  ...
  if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock)
    return !1;
  let o = n.resolve($n(s, !0, !0));
  return !o.parent.isTextblock || o.pos > t || $n(o, !0, !1) < t ? !1 : r.parent.content.cut(r.parentOffset).eq(o.parent.content);
}
function $n(n, e, t) {
...
function tf(n, e, t, r, i) {
  ...
  if (o < s && n.size < e.size) {
    let a = r <= s && r >= o ? s - r : 0;
    s -= a, s && s < e.size && Di(e.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), l = s + (l - o), o = s;
  } else if (l < s) {
    let a = r <= s && r >= l ? s - r : 0;
    s -= a, s && s < n.size && Di(n.textBetween(s - 1, s + 1)) && (s += a ? 1 : -1), o = s + (o - l), l = s;
  }
...
class nf {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    e.storedMarks && this.composing && (Co(this), o = !0), this.state = e;
    let l = i.plugins != e.plugins || this._props.plugins != t.plugins;
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let u = vi(this);
      sf(u, this.nodeViews) && (this.nodeViews = u, s = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && sr(this), this.editable = Ii(this), Ri(this);
    let a = Hn(this), c = Ei(this), f = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", h = s || !this.docView.matchesNode(e.doc, c, a);
    (h || !e.selection.eq(i.selection)) && (o = !0);
    let d = f == "preserve" && o && this.dom.style.overflowAnchor == null && Pa(this);
    if (o) {
      this.domObserver.stop();
      let u = h && (U || $) && !this.composing && !i.selection.empty && !e.selection.empty && rf(i.selection, e.selection);
      if (h) {
        let p = $ ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = Bc(this)), (s || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = fi(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (u = !0);
      }
      u || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && oc(this)) ? be(this, u) : (ao(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), f == "reset" ? this.dom.scrollTop = 0 : f == "to selection" ? this.scrollToSelection() : d && Va(d);
  }
  /**
  @internal
  */
  scrollToSelection() {
    ...
    if (!this.someProp("handleScrollToSelection", (t) => t(this))) if (this.state.selection instanceof k) {
      ...
      t.nodeType == 1 && ii(this, t.getBoundingClientRect(), e);
    } else
      ii(this, this.coordsAtPos(this.state.selection.head, 1), e);
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Mo(e.slice, e.move, i < 0 ? void 0 : k.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && Fa(this.dom), be(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (wc(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Hn(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Oa());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? J && this.root.nodeType === 11 && Ea(this.dom.ownerDocument) == this.dom && Uc(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
if (typeof WeakMap < "u") {
  ...
  or = (e) => n.get(e), lr = (e, t) => (n.set(e, t), t);
} else {
  const n = [];
  let t = 0;
  or = (r) => {
    ...
    for (let p = 0; ; p++) {
      ...
      for (let M = 0; M < b; M++) {
        ...
        for (let I = 0; I < g; I++) {
          ...
          const D = w && w[I];
          if (D) {
            const Y = (T + I) % e * 2, ke = o[Y];
            ke == null || ke != D && o[Y + 1] == 1 ? (o[Y] = D, o[Y + 1] = 1) : ke == D && o[Y + 1]++;
          }
        }
      }
      i += g, f += m.nodeSize;
...
function af(n, e, t) {
  ...
  for (let i = 0; i < n.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      h != null && (!a.colwidth || a.colwidth[c] != h) && ((l || (l = cf(a)))[c] = h);
    }
...
function Do(n, e, t) {
  const r = n.node(-1), i = E.get(r), s = n.start(-1), o = i.nextCell(n.pos - s, e, t);
...
var z = class pe extends S {
  ...
  // cell.
  constructor(e, t = e) {
    const r = e.node(-1), i = E.get(r), s = e.start(-1), o = i.rectBetween(
      e.pos - s,
      t.pos - s
    ), l = e.node(0), a = i.cellsInRect(o).filter((f) => f != t.pos - s);
    a.unshift(t.pos - s);
    const c = a.map((f) => {
      const h = r.nodeAt(f);
      if (!h)
  ...
  // cells.
  content() {
    const e = this.$anchorCell.node(-1), t = E.get(e), r = this.$anchorCell.start(-1), i = t.rectBetween(
    ...
    for (let a = i.top; a < i.bottom; a++) {
      ...
      for (let f = a * t.width + i.left, h = i.left; h < i.right; h++, f++) {
        ...
        if (u.top < i.top || u.bottom > i.bottom) {
          const b = {
            ...p.attrs,
            rowspan: Math.min(u.bottom, i.bottom) - Math.max(u.top, i.top)
          };
  ...
  forEachCell(e) {
    const t = this.$anchorCell.node(-1), r = E.get(t), i = this.$anchorCell.start(-1), s = r.cellsInRect(
      r.rectBetween(
  ...
  static colSelection(e, t = e) {
    const r = e.node(-1), i = E.get(r), s = e.start(-1), o = i.findCell(e.pos - s), l = i.findCell(t.pos - s), a = e.node(0);
  ...
  // right of the table.
  isRowSelection() {
    const e = this.$anchorCell.node(-1), t = E.get(e), r = this.$anchorCell.start(-1), i = t.colCount(this.$anchorCell.pos - r), s = t.colCount(this.$headCell.pos - r);
    if (Math.min(i, s) > 0)
      return !1;
  ...
  eq(e) {
    return e instanceof pe && e.$anchorCell.pos == this.$anchorCell.pos && e.$headCell.pos == this.$headCell.pos;
  }
  ...
  getBookmark() {
    return new uf(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
var uf = class Eo {
  ...
  resolve(e) {
    ...
    return t.parent.type.spec.tableRole == "row" && r.parent.type.spec.tableRole == "row" && t.index() < t.parent.childCount && r.index() < r.parent.childCount && Nr(t, r) ? new z(t, r) : S.near(r, 1);
  }
};
function pf(n) {
...
function yf(n, e, t) {
  ...
  if (r instanceof k && (o = r.node.type.spec.tableRole)) {
    if (o == "cell" || o == "header_cell")
      ...
      const l = E.get(r.node), a = r.from + 1, c = a + l.map[l.width * l.height - 1];
      s = z.create(i, a + 1, c);
    }
  } else r instanceof C && mf(r) ? s = C.create(i, r.from) : r instanceof C && gf(r) && (s = C.create(i, r.$from.start(), r.$from.end()));
  return s && (e || (e = n.tr)).setSelection(s), e;
}
var bf = new vt("fix-tables");
function Ro(n, e, t, r) {
  const i = n.childCount, s = e.childCount;
  e:
    for (let o = 0, l = 0; o < s; o++) {
      const a = e.child(o);
      for (let c = l, f = Math.min(i, o + 3); c < f; c++)
        if (n.child(c) == a) {
          l = c + 1, t += a.nodeSize;
          continue e;
        }
      r(a, t), l < i && n.child(l).sameMarkup(a) ? Ro(n.child(l), a, t + 1, r) : a.nodesBetween(0, a.content.size, r, t + 1), t += a.nodeSize;
    }
}
function xf(n, e) {
  let t;
  const r = (i, s) => {
    i.type.spec.tableRole == "table" && (t = kf(n, i, s, t));
  };
  return e ? e.doc != n.doc && Ro(e.doc, n.doc, 0, r) : n.doc.descendants(r), t;
}
function kf(n, e, t, r) {
  const i = E.get(e);
  if (!i.problems)
  ...
  for (let a = 0; a < i.problems.length; a++) {
    ...
    if (c.type == "collision") {
      ...
      if (!f)
        continue;
      const h = f.attrs;
      for (let d = 0; d < h.rowspan; d++)
        s[c.row + d] += c.n;
      r.setNodeMarkup(
        r.mapping.map(t + 1 + c.pos),
        null,
        dt(h, h.colspan - c.n, c.n)
      );
  ...
  for (let a = 0, c = t + 1; a < i.height; a++) {
    ...
    if (d > 0) {
      ...
      const p = [];
      for (let g = 0; g < d; g++) {
        const b = fe(n.schema)[u].createAndFill();
        b && p.push(b);
      }
  ...
  return r.setMeta(bf, { fixTables: !0 });
}
function Io(n) {
  const e = n.selection, t = Or(n), r = t.node(-1), i = t.start(-1), s = E.get(r);
...
function Sf(n) {
  return function(e, t) {
    if (!Cn(e))
      return !1;
    if (t) {
      const r = fe(e.schema), i = Io(e), s = e.tr, o = i.map.cellsInRect(
        n == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function Tr(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? Sf(n) : function(t, r) {
    if (!Cn(t))
      return !1;
    if (r) {
      const i = fe(t.schema), s = Io(t), o = t.tr, l = Vi("row", s, i), a = Vi(
        "column",
        s,
        i
      ), f = (n === "column" ? l : n === "row" ? a : !1) ? 1 : 0, h = n == "column" ? {
        left: 0,
        top: f,
        right: 1,
        bottom: s.map.height
...
function Fi(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(C.between(i, df(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function Jt(n, e) {
  ...
  if (!(t instanceof z))
    return !1;
  if (e) {
    const r = n.tr, i = fe(n.schema).cell.createAndFill().content;
    t.forEachCell((s, o) => {
...
function Mf(n, e) {
  ...
  for (let i = 0; i < t.length; i++)
    if (i >= e.length && e.push(y.empty), t[i] < r) {
      const s = fe(n).cell.createAndFill(), o = [];
      for (let l = t[i]; l < r; l++)
        o.push(s);
...
function Of({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const s = [], o = [];
    for (let l = 0; l < t.length; l++) {
      ...
      for (let f = s[l] || 0, h = 0; f < r; h++) {
        ...
        f + d.attrs.colspan > r && (d = d.type.createChecked(
          dt(
            d.attrs,
            d.attrs.colspan,
            f + d.attrs.colspan - r
          ...
          d.content
        )), c.push(d), f += d.attrs.colspan;
        for (let u = 1; u < d.attrs.rowspan; u++)
          s[l + u] = (s[l + u] || 0) + d.attrs.colspan;
      }
      o.push(y.from(c));
    }
    t = o, n = r;
...
function Nf(n, e, t, r, i, s, o) {
  const l = n.doc.type.schema, a = fe(l);
  let c, f;
  if (i > e.width)
    for (let h = 0, d = 0; h < e.height; h++) {
      const u = t.child(h);
      d += u.nodeSize;
      const p = [];
      let m;
  ...
  if (s > e.height) {
    ...
    for (let p = 0, m = (e.height - 1) * e.width; p < Math.max(e.width, i); p++) {
      ...
      h.push(
        g ? f || (f = a.header_cell.createAndFill()) : c || (c = a.cell.createAndFill())
      );
    }
...
function $i(n, e, t, r, i) {
  ...
  function u() {
    if (s = t ? h.doc.nodeAt(t - 1) : h.doc, !s)
      throw new Error("No table found");
    o = E.get(s), d = h.mapping.maps.length;
  }
  Nf(h, o, s, t, c, f, d) && u(), Li(h, o, s, t, a, c, l, d) && u(), Li(h, o, s, t, a, c, f, d) && u(), Hi(h, o, s, t, l, f, a, d) && u(), Hi(h, o, s, t, l, f, c, d) && u();
  for (let p = l; p < f; p++) {
...
function qt(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(o), a = Do(l, n, e);
      let c;
...
function Df(n, e, t) {
  ...
  if (i instanceof z) {
    r || (r = {
      ...
      rows: [
        y.from(
          cr(fe(n.state.schema).cell, t)
        )
      ]
    });
    const s = i.$anchorCell.node(-1), o = i.$anchorCell.start(-1), l = E.get(s).rectBetween(
      i.$anchorCell.pos - o,
      i.$headCell.pos - o
    );
    return r = Of(r, l.right - l.left, l.bottom - l.top), $i(n.state, n.dispatch, o, l, r), !0;
  } else if (r) {
    const s = Or(n.state), o = s.start(-1);
    return $i(
      n.state,
      n.dispatch,
      o,
      E.get(s.node(-1)).findCell(s.pos - o),
      r
    ), !0;
  } else
    return !1;
...
function Ef(n, e) {
  ...
  if (e.ctrlKey || e.metaKey)
    return;
  const r = Wi(n, e.target);
  let i;
  if (e.shiftKey && n.state.selection instanceof z)
    s(n.state.selection.$anchorCell, e), e.preventDefault();
  else if (e.shiftKey && r && (i = Vt(n.state.selection.$anchor)) != null && ((t = Wn(n, e)) == null ? void 0 : t.pos) != i.pos)
  ...
  function o() {
    n.root.removeEventListener("mouseup", o), n.root.removeEventListener("dragstart", o), n.root.removeEventListener("mousemove", l), Ne.getState(n.state) != null && n.dispatch(n.state.tr.setMeta(Ne, -1));
  }
  function l(a) {
    const c = a, f = Ne.getState(n.state);
    let h;
    if (f != null)
      h = n.state.doc.resolve(f);
    else if (Wi(n, c.target) != r && (h = Wn(n, e), !h))
      return o();
    h && s(h, c);
  }
...
var Rf = class {
  constructor(n, e) {
    this.node = n, this.defaultCellMinWidth = e, this.dom = document.createElement("div"), this.dom.className = "tableWrapper", this.table = this.dom.appendChild(document.createElement("table")), this.table.style.setProperty(
      ...
      `${e}px`
    ), this.colgroup = this.table.appendChild(document.createElement("colgroup")), fr(n, this.colgroup, this.table, e), this.contentDOM = this.table.appendChild(document.createElement("tbody"));
  }
  update(n) {
    return n.type != this.node.type ? !1 : (this.node = n, fr(
      n,
      this.colgroup,
      this.table,
...
function If({
  ...
  const s = new ut({
    ...
    state: {
      init(o, l) {
        var a, c;
        const f = (c = (a = s.spec) == null ? void 0 : a.props) == null ? void 0 : c.nodeViews, h = fe(l.schema).table.name;
...
var vf = class Xt {
  ...
  apply(e) {
    ...
    if (t.activeHandle > -1 && e.docChanged) {
      ...
      return ar(e.doc.resolve(i)) || (i = -1), new Xt(i, t.dragging);
    }
    return t;
  }
};
function zf(n, e, t, r) {
  ...
  if (i && !i.dragging) {
    ...
    if (s) {
      ...
      e.clientX - l <= t ? o = Ji(n, e, "left", t) : a - e.clientX <= t && (o = Ji(n, e, "right", t));
    }
    if (o != i.activeHandle) {
      if (!r && o !== -1) {
        const l = n.state.doc.resolve(o), a = l.node(-1), c = E.get(a), f = l.start(-1);
...
function Bf(n) {
  ...
  e && e.activeHandle > -1 && !e.dragging && zo(n, -1);
}
function Pf(n, e, t, r) {
  var i;
...
function Ji(n, e, t, r) {
  ...
  if (t == "right")
    return l.pos;
  const a = E.get(l.node(-1)), c = l.start(-1), f = a.map.indexOf(l.pos - c);
...
function Lf(n, e, t) {
  const r = n.state.doc.resolve(e), i = r.node(-1), s = E.get(i), o = r.start(-1), l = s.colCount(r.pos - o) + r.nodeAfter.attrs.colspan - 1, a = n.state.tr;
  for (let c = 0; c < s.height; c++) {
    const f = c * s.width + l;
    if (c && s.map[f] == s.map[f - s.width])
      continue;
    const h = s.map[f], d = i.nodeAt(h).attrs, u = d.colspan == 1 ? 0 : l - s.colCount(h);
    if (d.colwidth && d.colwidth[u] == t)
      continue;
    const p = d.colwidth ? d.colwidth.slice() : Hf(d.colspan);
    p[u] = t, a.setNodeMarkup(o + h, null, { ...d, colwidth: p });
  }
  a.docChanged && n.dispatch(a);
}
function Ki(n, e, t, r) {
  const i = n.state.doc.resolve(e), s = i.node(-1), o = i.start(-1), l = E.get(s).colCount(i.pos - o) + i.nodeAfter.attrs.colspan - 1;
...
function $f(n, e) {
  ...
  if (!s)
    return A.empty;
  const o = E.get(s), l = i.start(-1), a = o.colCount(i.pos - l) + i.nodeAfter.attrs.colspan - 1;
...
const Bo = "app.grapesjs.com", Po = "app-stage.grapesjs.com", Jf = "app2.grapesjs.com", qf = "app-stage2.grapesjs.com", ji = [
  Bo,
  Jf,
  Po,
  qf,
  ...
  // For Sandpack demos
], Kf = "license:check:start", jf = "license:check:end", Uf = () => typeof window < "u", Gf = ({ isDev: n, isStage: e }) => `${n ? "" : `https://${e ? Po : Bo}`}/api`, _f = () => {
  const n = Uf() && window.location.hostname;
...
async function Xf({
  ...
  const l = `${e || Gf({ isDev: !1, isStage: !1 })}${n}`, a = {
    method: t,
    headers: {
...
async function Qf({
  ...
  n.on(Kf, (f) => {
    ...
    if (!o) {
      if (l) return;
      if (r) {
        const f = await eh({ licenseKey: r, pluginName: t, baseApiUrl: s });
        f && c(f);
      } else
...
const th = (n, e) => {
  ...
  const t = "keydown", r = (s) => {
    var o;
    s.key === "Escape" && ((o = n.getEditing()) == null || o.trigger("disable"));
  }, i = () => document.removeEventListener(t, r);
  return n.onReady(() => {
...
const Ot = (n) => {
...
}, Gi = "data-gs-mrk-fs", _i = "data-gs-ib", Vo = "data-gs-mrk-wrap", pn = "data-gs-ifrg", xe = "attrs", Ar = {
  [xe]: { default: "{}" }
}, de = {
  [xe]: { default: {} }
}, Dr = (n) => ({
  [xe]: JSON.stringify(Ot(n))
}), ue = (n) => ({ attrs: Ot(n) }), mt = (n) => (e) => [n, e.attrs.attrs, 0], ye = (n) => n.attrs[xe] ? JSON.parse(n.attrs[xe]) : {}, rh = {
  doc: {
    content: "block+"
  },
  text: {
  ...
  inlineFragment: {
    ...
    content: "inline*",
    isTextBlock: !0,
    parseDOM: [{ tag: `span[${pn}]`, getAttrs: ue }],
    toDOM: () => ["span", { [pn]: "" }, 0]
  },
  div: {
    group: "block",
  ...
  image: {
    ...
    selectable: !0,
    attrs: de,
    parseDOM: [{ tag: "img[src]", getAttrs: ue }],
  ...
  nodes: rh,
  marks: sh
}), Ft = /* @__PURE__ */ new WeakMap(), Er = /* @__PURE__ */ new WeakMap(), oh = (n, e, t) => {
  Ft.set(n, { view: e, gjsView: t, initialDoc: e.state.doc }), Er.set(e, { el: n, gjsView: t });
}, lh = (n, e) => {
  Ft.delete(n), Er.delete(e);
}, Yt = (n) => Ft.get(n), Fo = (n) => Er.get(n), Yi = (n) => {
  const e = Yt(n), t = e == null ? void 0 : e.view, r = e == null ? void 0 : e.initialDoc;
  return !(t && r && r.eq(t.state.doc));
}, Jn = (n) => {
  var e, t;
  return (t = (e = Fo(n)) == null ? void 0 : e.gjsView) == null ? void 0 : t.model;
}, ah = (n) => n.dispatchEvent(new CustomEvent("input"));
function ch(n) {
  const e = (t) => {
    if (t.tagName === "SPAN" && t.hasAttribute(pn)) {
      if (t.getAttribute("style")) {
        t.removeAttribute(pn);
        return;
      }
      ...
      Array.from(t.children).forEach((r) => e(r));
  };
  e(n);
}
const fh = (n, e) => {
  const t = Lo(n);
  return t && kh(t) ? dh(n, e) : t ? Ls(() => ({ type: n.schema.nodes.div }))(n, e) : !1;
}, hh = (n, e) => (t, r) => {
  var l;
  const i = Lo(t), s = Ft.get(n.el).view, o = (l = e.onEnter) == null ? void 0 : l.call(e, {
    ...n,
    node: i,
    commands: Rr(s, n.editor, e),
    proseMirror: { view: s, dispatch: r }
  });
  return o !== void 0 ? o : fh(t, r);
};
function Lo(n) {
...
function uh(n, e, t) {
  ...
  if (!s.empty || t)
    o.doc.nodesBetween(s.from, s.to, (a, c) => {
      var f, h;
      if (a.type === r.schema.nodes.image) {
        ...
        Ho(a) ? o.setBlockType(s.from, void 0, r.schema.nodes.div, {
          attrs: { style: d }
        }) : o.setNodeMarkup(c, void 0, {
          ...a.attrs,
          attrs: {
...
function ph(n) {
  ...
  try {
    const u = { href: t, target: i }, p = ((d = (h = r.commandAttrs) == null ? void 0 : h.link) == null ? void 0 : d.call(h, u)) || u, m = f.create({ [xe]: JSON.stringify(p) });
    c.addMark(a.from, a.to, m), o(c.scrollIntoView());
  } catch (u) {
...
const He = (n, e) => {
  ...
  for (let s = i.depth; s > 0; s--) {
    ...
    if (e(o))
      return {
        pos: s > 0 ? i.before(s) : 0,
        start: i.start(s),
        depth: s,
        node: o
      };
  }
}, gh = (n) => (n || "").split(";").map((e) => e.split(":")).reduce(
...
const bh = (n, e) => {
...
}, hr = (n) => n.isBlock, Ho = (n) => n.type.name === "inlineFragment", xh = (n) => hr(n) && !Ho(n), $o = (n) => n.type.name === "bulletList", Wo = (n) => n.type.name === "orderedList", kh = (n) => n.type.name === "heading", Sh = (n) => $o(n) || Wo(n), Zi = (n, e) => {
  var s, o;
  const t = (s = He(n, (l) => l.type === e)) == null ? void 0 : s.node, r = n.state.schema.nodes.listItem;
  let i;
  return t ? i = _n(r) : (o = He(n, Sh)) != null && o.node ? i = yh(_n(r), ti(e)) : i = ti(e), i(n.state, n.dispatch);
}, Jo = (n, e) => {
  const { selection: t } = n.state;
  return [...t.$from.marks(), ...t.$to.marks()].find((r) => r.type.name === e);
}, Ch = (n) => {
  var o;
  const { view: e, prop: t, editor: r, propCSS: i } = n, s = (o = He(e, xh)) == null ? void 0 : o.node;
  if (s) {
    const l = s.attrs.attrs || {}, a = gh(l.style);
    if (t in a)
      return a[t] || "";
    if (l.id) {
  ...
  const { view: e, prop: t, markName: r, editor: i, propCSS: s } = n, o = Jo(e, r);
  if (o) {
    const l = o.attrs;
    if (l[t])
      return l[t];
  ...
  const { dispatch: r } = n, { nodes: i, marks: s } = n.state.schema, o = {
    text: {
      selected: () => {
      ...
      replace: (l, a = {}) => {
        const { state: c } = n, { from: f } = c.selection;
        let h = c.tr.replaceSelectionWith(c.schema.text(l));
        a.select && (h = h.setSelection(C.create(h.doc, f, f + l.length))), r == null || r(h);
      },
      replaceHtml: (l) => {
        const { schema: a, selection: c, tr: f } = n.state, h = document.createElement("div");
        h.innerHTML = l;
        const d = Ge.fromSchema(a).parse(h), { from: u, to: p } = c;
        return r == null ? void 0 : r(f.replaceRangeWith(u, p, d).scrollIntoView());
      },
      wrapStyle: () => {
        const l = Jn(n), a = o.text.selected(), c = `i${e.Components._createId().slice(0, 4)}`;
        o.text.replaceHtml(`<span id="${c}" ${Vo}>${a}</span>`), l == null || l.trigger("disable"), setTimeout(() => {
          const f = l == null ? void 0 : l.find(`#${c}`)[0];
          f && e.select(f);
        });
      },
      createBreak: () => {
        const { state: l } = n, a = l.tr.replaceSelectionWith(i.inlineBreak.create()).scrollIntoView();
    ...
    link: {
      get: () => {
        const l = Jn(n), a = l == null ? void 0 : l.getTrait("href");
        if (l != null && l.is("link"))
      ...
      create: (l) => {
        const a = Jn(n), c = a == null ? void 0 : a.getTrait("href"), { url: f, target: h } = l, d = () => {
          var p, m;
          const u = (m = (p = Fo(n)) == null ? void 0 : p.gjsView) == null ? void 0 : m.el;
          u && u.contentEditable !== "true" && (u.contentEditable = "true"), n.focus();
        };
        a != null && a.is("link") ? (a.addAttributes({ href: f, target: h }), d()) : c ? (a == null || a.addAttributes({ [c.getName()]: f }), d()) : ph({ view: n, href: f, target: h, options: t });
      }
    },
    alignText: {
      get: () => Ch({ view: n, editor: e, prop: "textAlign", propCSS: "text-align" }),
      set: (l) => uh(n, l.value, !0)
    },
    fontSize: {
      get: () => wh({ view: n, editor: e, markName: "font_size", prop: "size", propCSS: "font-size" }),
      set: (l) => mh(n, l.value)
    },
    image: {
      open() {
        const l = "assetLayout", { state: a, dispatch: c } = n, { selection: f, doc: h } = a, d = h.textBetween(f.from, f.to, " "), u = {
          id: l,
          ...
          layout: {
            type: "panelAssets",
            onSelect: (p) => {
              const m = { alt: d, src: p.asset.getSrc() };
              c(a.tr.replaceSelectionWith(i.image.createAndFill({ attrs: m })));
            }
          }
        };
    ...
    heading: {
      get: () => {
        var a;
        const l = (a = He(n, hr)) == null ? void 0 : a.node;
        return `${(l == null ? void 0 : l.attrs.level) || ""}`;
      },
      set: ({ value: l }) => {
        var f;
        const { state: a } = n, c = (f = He(n, hr)) == null ? void 0 : f.node;
        ta(a.schema.nodes.heading, {
    ...
    listBullet: {
      isActive: () => {
        var l;
        return !!((l = He(n, $o)) != null && l.node);
      },
      toggle: () => Zi(n, i.bulletList)
    },
    listOrdered: {
      isActive: () => {
        var l;
        return !!((l = He(n, Wo)) != null && l.node);
      },
      toggle: () => Zi(n, i.orderedList)
    }
  };
  return o;
};
  ...
  let e = new ut({
    ...
    props: {
      handleTextInput(t, r, i, s) {
        return Qi(t, r, i, s, n, e);
      },
      handleDOMEvents: {
        compositionend: (t) => {
          setTimeout(() => {
            let { $cursor: r } = t.state.selection;
            r && Qi(t, r.pos, r.pos, "", n, e);
          });
        }
      }
    },
...
function Qi(n, e, t, r, i, s) {
  if (n.composing)
    return !1;
  let o = n.state, l = o.doc.resolve(e), a = l.parent.textBetween(Math.max(0, l.parentOffset - Oh), l.parentOffset, null, "￼") + r;
...
const Th = new Be(/--$/, "—"), Ah = new Be(/\.\.\.$/, "…"), Dh = new Be(/(?:^|[\s\{\[\(\<'"\u2018\u201C])(")$/, "“"), Eh = new Be(/"$/, "”"), Rh = new Be(/(?:^|[\s\{\[\(\<'"\u2018\u201C])(')$/, "‘"), Ih = new Be(/'$/, "’"), vh = [Dh, Eh, Rh, Ih];
function Ir(n, e, t = null, r) {
  return new Be(n, (i, s, o, l) => {
    let a = t instanceof Function ? t(s) : t, c = i.tr.delete(o, l), f = c.doc.resolve(o), h = f.blockRange(), d = h && ws(h, e, a);
    if (!d)
      return null;
    c.wrap(h, d);
    let u = c.doc.resolve(o - 1).nodeBefore;
    return u && u.type == e && yn(c.doc, o - 1) && (!r || r(s, u)) && c.join(o - 1), c;
  });
}
function qo(n, e, t = null) {
...
function Fh(n, e) {
  return qo(new RegExp("^(#{1," + e + "})\\s$"), n, (t) => ({
    level: t[1].length
  }));
}
function Lh(n) {
  const e = vh.concat(Ah, Th);
  let t;
  return (t = n.nodes.blockquote) && e.push(zh(t)), (t = n.nodes.orderedList) && e.push(Bh(t)), (t = n.nodes.bulletList) && e.push(Ph(t)), (t = n.nodes.codeBlock) && e.push(Vh(t)), (t = n.nodes.heading) && e.push(Fh(t, 6)), Nh({ rules: e });
}
const Hh = "rteProseMirror", $h = rt.free, Q = "rte:selectionchange", Z = {
  ...
  const { editor: t, el: r } = n, i = Ft.get(r).view, s = Rr(i, t, e), o = {
    ...
    wrapStyle: {
      ...
      editorEvents: {
        [Q]: ({ setState: c }) => {
          c({ disabled: i.state.selection.empty });
        }
      },
      onClick: () => s.text.wrapStyle()
    },
    bold: {
      id: "bold",
      icon: Z.bold,
      ...
      editorEvents: {
        [Q]: ({ setState: c }) => {
          c({
            ...
            disabled: i.state.selection.empty
          });
        }
      },
      onClick: ({ event: c }) => {
        const f = c.currentTarget || c.target, { x: h, y: d, width: u, height: p } = f.getBoundingClientRect(), m = "linkLayout", g = () => t.runCommand(un.layoutRemove, { id: m }), b = s.link.get(), w = {
          id: m,
          style: { width: 240 },
          disablePropagation: !0,
            ...
            children: [
              {
                ...
                onChange: ({ value: M, setState: T }) => T({ value: M })
              },
              {
                type: "selectField",
                name: "target",
        ...
        t.runCommand(un.layoutToggle, w);
      }
    },
    alignText: {
      id: "alignText",
      ...
      value: "",
      options: [
        { id: "left", icon: Z.alignTextLeft },
        { id: "center", icon: Z.alignTextCenter },
        { id: "right", icon: Z.alignTextRight },
        { id: "justify", icon: Z.alignTextJustify }
      ],
      editorEvents: {
        [Q]: ({ setState: c }) => {
...
class Jh {
  ...
  handleDoubleClick(e) {
    ...
    Rr(r, t, {}).image.open(), e.preventDefault();
  }
  update(e) {
...
const qh = function(n, e = {}) {
  const t = {
    ...
    var g, b;
    const c = ((g = t.schema) == null ? void 0 : g.call(t, { editor: n, schema: Xi })) || Xi, { nodes: f, marks: h } = c, d = {
      ...a,
      component: a.view.model,
      editor: n,
      el: l
    }, u = Ge.fromSchema(c).parse(l), p = nt.create({
      doc: u,
      schema: c,
      plugins: (b = t.plugins) == null ? void 0 : b.call(t, {
        ...
        plugins: [
          ...
          Pn({
            Enter: At(Fs, Sa(f.listItem), hh(d, t)),
      ...
      { mount: l },
      {
        ...
        dispatchTransaction(w) {
          ...
          I && (ah(((Y = a == null ? void 0 : a.view) == null ? void 0 : Y.el) || l), m.focus()), (D || I) && n.trigger(Q);
        }
      }
    );
  ...
  n.setCustomRte({
    ...
    async enable(l, a, c) {
      ...
      if (f) return f;
      const h = r(l, c);
      return oh(l, h, c.view), bh(h, c), h;
    },
    disable(l) {
      const a = Yt(l), c = a == null ? void 0 : a.view;
      if (c) {
        const f = Yi(l);
        return lh(l, c), f || n.once(n.RichTextEditor.events.disable, () => {
    ...
    getContent(l, a, c) {
      ...
      if (f) {
        ...
        const p = document.createElement("div"), m = Ye.fromSchema(d).serializeFragment(u.content);
        return m.childNodes.forEach((g) => {
          g.nodeType === Node.ELEMENT_NODE && g.innerHTML === "" && (g.innerHTML = "<br/>");
        }), p.appendChild(m), ch(p), l.classList.remove("ProseMirror-focused"), p.innerHTML;
      }
      return l.innerHTML;
    }
  });
  const s = nh(n, t.enableOnClick), o = th(n, t.disableOnEsc);
  Qf({
    editor: n,
