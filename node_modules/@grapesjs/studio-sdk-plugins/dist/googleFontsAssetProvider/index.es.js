...
const x = "app.grapesjs.com", R = "app-stage.grapesjs.com", I = "app2.grapesjs.com", k = "app-stage2.grapesjs.com", w = [
  x,
  I,
  R,
  k,
  ...
  // For Sandpack demos
], $ = "license:check:start", E = "license:check:end", M = () => typeof window < "u", U = ({ isDev: e, isStage: t }) => `${e ? "" : `https://${t ? R : x}`}/api`, j = () => {
...
async function N({
  ...
  const u = n ? new URLSearchParams(n).toString() : "", a = u ? `?${u}` : "", g = await fetch(`${l}${a}`, c);
  if (!g.ok)
...
async function _({
  ...
  let r = "", i = !1;
  const l = j(), c = (a) => {
    console.warn("Cleanup plugin:", s, "Reason:", a), n();
  }, u = (a = {}) => {
    var A;
    ...
    if (!(f || a.license) || g)
      ...
      const O = L[t], G = L[d];
      O > G && c({ pluginRequiredPlan: t, licensePlan: d });
    }
  };
  e.on($, (a) => {
...
const b = (e) => e.replaceAll('"', "").replaceAll("'", ""), y = (e) => e.includes(",") ? e : /\s/.test(e) ? `'${b(e)}'` : b(e), F = (e, t, s) => ({ family: e, variant: t, ...s }), D = (e, t) => {
  ...
  var l;
  const s = D(e.family, e), o = s.menuVariant ?? ((l = Object.values(s.variants)) == null ? void 0 : l[0]);
  if (!o)
    return "Arial, Helvetica, sans-serif";
  const { source: n, descriptors: r } = o, i = b(o.family);
  if (!t) {
    const c = new FontFace(i, `url("${n}")`, r), u = Array.from(document.fonts.values()).filter((a) => a.family === i);
    for (const a of u)
  ...
  src: e.menu,
  name: e.family,
  customData: { font: V(e), needsLoading: !0 }
}), H = (e) => {
...
const z = (e) => {
  ...
  const { apiKey: t, searchParams: s } = e, o = (n = {}) => {
    const r = "https://www.googleapis.com/webfonts/v1/webfonts", i = z(n);
    return `${r}?${i}`;
  };
  return {
    id: "google-fonts",
    ...
    async onLoad() {
      ...
      const n = {
        ...
        ...n,
        ...r
      }, c = await (await fetch(o(i))).json();
      return (u = c.items) != null && u.length ? (h = c.items.map(S), h) : [];
    },
    itemLayout: (n) => {
      const r = h.find((l) => l.id === n.assetProps.id), i = H(r);
      return {
        type: "column",
        onClick: () => n.onSelect(r),
        htmlAttrs: {
          title: r.name
        },
        style: {
