  ...
  return {
    ...
    ...n && {
      ...
      toStyle(s, { name: l, property: c }) {
        const [p, a] = c.getProperties(), d = s[p.getId()], u = s[a.getId()];
        return {
          [l]: d === u ? d : `${d} ${u}`
        };
      }
...
function Dt(t, e) {
  ...
  o || r.addOption({ id: "grid", label: "Grid" }), i.addProperty(
  ...
  ), i.addProperty(
    {
      ...
      toStyle(s, { name: l }) {
        const c = s["grid-row-start"] || "auto", p = s["grid-row-end"] || "auto", a = s["grid-column-start"] || "auto", d = s["grid-column-end"] || "auto";
        return {
          [l]: `${c} / ${a} / ${p} / ${d}`
        };
      }
