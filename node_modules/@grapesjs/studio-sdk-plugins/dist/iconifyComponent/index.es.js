const _ = "app.grapesjs.com", D = "app-stage.grapesjs.com", B = "app2.grapesjs.com", H = "app-stage2.grapesjs.com", O = [
  ...
  // For Sandpack demos
], C = "license:check:start", F = "license:check:end", W = () => typeof window < "u", K = ({ isDev: e, isStage: t }) => `${e ? "" : `https://${t ? D : _}`}/api`, V = () => {
...
async function q({
  ...
  e.on(C, (i) => {
    ...
    if (!a) {
      if (r) return;
      if (s) {
        const i = await J({ licenseKey: s, pluginName: o, baseApiUrl: g });
        i && c(i);
      } else
...
}, Z = "iconifyComponent", Q = v.startup, m = { ratioDefault: !0, tc: !1, cl: !1, cr: !1, bc: !1 }, I = `<svg viewBox="0 0 24 24">
