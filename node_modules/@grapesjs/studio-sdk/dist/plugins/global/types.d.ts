...
export declare enum StudioCommands {
     ...
     * @example
     * const { output, error } = editor.runCommand(StudioCommands.validateCode, { code: '<div>Hello</div>' });
     */
...
export interface StudioCommandValidateCodeOptions {
    code: string;
