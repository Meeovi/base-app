...
import { join, resolve, extname, basename, relative, dirname } from 'pathe';
...
export { automd as a, defineGenerator as d, loadConfig as l, resolveConfig as r, transform as t };
