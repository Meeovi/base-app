...
export const pageComponentMap: Record<string, AsyncComponentLoader> = {
  ...
  'upload center': () => import('../../../../apps/base/app/components/pages/upload.vue'),
  ...
  'notifications': () => import('../../../../apps/base/app/components/pages/notifications.vue'),
  'offline': () => import('../../../../apps/base/app/components/pages/offline.vue'),
